...
public class DateUtils {
    ...
    public static String dateToString(Date date){
    	SimpleDateFormat sdf=new SimpleDateFormat(TIME_PATTERN);
    	return sdf.format(date).replace("-", "").replace(":", "").replace(" ", "");
    }
    public static String dateToShortString(Date date){
    	SimpleDateFormat sdf=new SimpleDateFormat("yyyy-MM-dd");
    	return sdf.format(date).replace("-", "").replace(" ", "");
    }
    /**
     * 转换日期格式：yyyy-MM-dd
     * @author Lip
     ...
     * @return
     */
    public static String dateFormatToShort(Date date){
    	SimpleDateFormat sdf=new SimpleDateFormat("yyyy-MM-dd");
     ...
     * @return
     */
    public static String dateFormatToLong(Date date){
    	SimpleDateFormat sdf=new SimpleDateFormat(TIME_PATTERN);
    	return sdf.format(date);
    }
    /**
     ...
     * @return
     */
    public static String dateFormatToShortChinese(Date date){
    	String dateStr = dateFormatToShort(date);
    	String[] dateArr = dateStr.split("-");
    	StringBuffer result = new StringBuffer();
    	result.append(dateArr[0]);
    	result.append(" 年 ");
    	result.append(dateArr[1]);
    	result.append(" 月 ");
