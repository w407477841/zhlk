...
@Controller
@RequestMapping("/zaikuzhiliangxinxi")
public class ZaiKuZhiLiangXinXiController extends BaseController {
	...
	public String listUI(){
		return  Common.BACKGROUND_PATH+"/yewuguanlixitong/liangshizhiliangzhuisu/zaikuzhiliangxinxilist";
	}
	
	@Token(save = true)
	@RequestMapping("/messageAddPage")
	public String messageAddPage(Model model) {
		return Common.BACKGROUND_PATH+ "/yewuguanlixitong/liangshizhiliangzhuisu/zaikuzhiliangxinxi/add";
	}
	...
	public String messageEditPage(Model model) {
		...
		return Common.BACKGROUND_PATH+ "/yewuguanlixitong/liangshizhiliangzhuisu/zaikuzhiliangxinxi/edit";
	}
