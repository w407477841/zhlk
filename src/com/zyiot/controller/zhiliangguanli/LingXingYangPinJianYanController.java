...
@Controller
@RequestMapping("/lingxingyangpinjianyan")
public class LingXingYangPinJianYanController extends BaseController {
	...
	public String listUI(){
		return  Common.BACKGROUND_PATH+"/yewuguanlixitong/zhiliangguanli/zhiliangjiance/lingxingyangpinjianyanlist";
	}
	@Token(save = true)
	@RequestMapping("/messageAddPage")
	public String messageAddPage(Model model) {
		return Common.BACKGROUND_PATH+ "/yewuguanlixitong/zhiliangguanli/zhiliangjiance/lingxingyangpinjianyan/add";
	}
	...
	public String messageEditPage(Model model) {
		...
		return Common.BACKGROUND_PATH+ "/yewuguanlixitong/zhiliangguanli/zhiliangjiance/lingxingyangpinjianyan/edit";
	}
