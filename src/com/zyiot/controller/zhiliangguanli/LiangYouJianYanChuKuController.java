...
@Controller
@RequestMapping("/liangyoujianyanchuku")
public class LiangYouJianYanChuKuController extends BaseController {
	...
	public String listUI(){
		return  Common.BACKGROUND_PATH+"/yewuguanlixitong/zhiliangguanli/zhiliangjiance/liangyoujianyanchukulist";
	}
	@Token(save = true)
	@RequestMapping("/messageAddPage")
	public String messageAddPage(Model model) {
		return Common.BACKGROUND_PATH+ "/yewuguanlixitong/zhiliangguanli/zhiliangjiance/liangyoujianyanchuku/add";
	}
	...
	public String messageEditPage(Model model) {
		...
		return Common.BACKGROUND_PATH+ "/yewuguanlixitong/zhiliangguanli/zhiliangjiance/liangyoujianyanchuku/edit";
	}
