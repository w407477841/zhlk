...
<body style="background-color:#d9edf7">
	...
	<div class=" col-md-4">
		<div class=" col-md-6">
			<h3 class="animated rubberBand">视频点位添加</h3>
		</div>
	</div>
	<div class=" col-md-8"></div>
	<div class=" col-md-12">
		<form id="form" name="form" method="post"
			action="${ctx}/shipindianwei/add.shtml">
				...
				<div class="form-group col-md-12">
					...
					<div class="has-warning">
						<input type="text" class="form-control easyui-validatebox"
							...
							name="shiPinDianWeiFormMap.name" value="" placeholder="请输入 ：点位名称">
					</div>
					</div>
				</div>
				<div class="form-group col-md-12">
				...
				<div class="form-group col-md-12">
					...
					<div class="has-warning">
						<input type="text" class="form-control easyui-validatebox"
							...
							name="shiPinDianWeiFormMap.ipNum" value=""
				...
				<div class="form-group col-md-12">
					...
					<div class="has-warning">
						<input type="text" class="form-control easyui-validatebox"
							...
							name="shiPinDianWeiFormMap.sLeft" value=""
				...
				<div class="col-md-2 div_label">纵轴位置<span>*</span></div>
					...
					<div class="has-warning">
						<input type="text" class="form-control easyui-validatebox"
							...
							name="shiPinDianWeiFormMap.top" value="" placeholder="请输入 ：纵轴位置">
					</div>
					</div>
				</div>
				<div class="form-group col-md-12">
				...
				<div class="col-md-2 div_label">IP地址<span>*</span></div>
					...
					<div class="has-warning">
						<input type="text" class="form-control easyui-validatebox"
							...
							name="shiPinDianWeiFormMap.ip" value="" placeholder="请输入 ：ip">
					</div>
					</div>
				</div>
				...
				<div class="col-md-2 div_label">IP端口<span>*</span></div>
					...
					<div class="has-warning">
						<input type="text" class="form-control easyui-validatebox"
							...
							name="shiPinDianWeiFormMap.port" value="" placeholder="请输入 ：port">
					</div>
					</div>
				</div>
				<div class="form-group col-md-12">
				<div class="col-md-2 div_label">用户名<span>*</span></div>
					...
					<div class="has-warning">
						<input type="text" class="form-control easyui-validatebox"
							...
							name="shiPinDianWeiFormMap.userName" value=""
							placeholder="请输入 ：用户名">
					</div>
					</div>
				</div>
				...
				<div class="col-md-2 div_label">密码<span>*</span></div>
					...
					<div class="has-warning">
						<input type="text" class="form-control easyui-validatebox"
							...
							name="shiPinDianWeiFormMap.password" value=""
							placeholder="请输入 ：密码">
					</div>
					</div>
				</div>
