							...
							<form id="searchForm" name="searchForm">
								<div class="form-group col-md-3">
										<select id="selectLocation" data-rel="chosen"
											...
											name="cangKuDianWeiFormMap.location_id" style="width:100%">
											<option value=""></option>
										</select>
									</div>
								<div class="form-group col-md-3">
									<input type="text" class="form-control"
										name="cangKuDianWeiFormMap.name" value="" placeholder="点位名称">
								</div>
							</form>
						</div>
						<div class=" col-md-12">
...
<script type="text/javascript" src="js/system/cangkudianwei/list.js"></script>
<script type="text/javascript">
