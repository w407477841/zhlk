...
<body style="background-color:#d9edf7">
	<div class=" col-md-4">
		<div class=" col-md-6">
			<h3 class="animated rubberBand">用户添加</h3>
		</div>
	</div>
				...
				<div class="col-md-10">
					<div class="has-warning">
						<input type="text" class="form-control easyui-validatebox"
							...
							name="userFormMap.userName" value="" placeholder="请输入 ：用户名称 " maxlength="20">
					</div>
				</div>
			</div>
			<div class="form-group col-md-6">
				...
				<div class="col-md-10">
					<div class="has-warning" id="divshow">
						<input type="text" class="form-control easyui-validatebox"
							missingMessage="请输登录账户" data-options="required:true" id="accountName"
							name="userFormMap.accountName" value="" onblur="isExit()"
							placeholder="请输入 ：登录账户" maxlength="20">
					</div>
				</div>
			</div>
				...
				<div class="col-md-10">
					<div class="has-warning">
						<input type="text" class="form-control" id="description"
							name="userFormMap.description" value="" placeholder="请输入 ：用户描述 " maxlength="100">
					</div>
				</div>
			</div>
			<div class="form-group col-md-6">
				...
				<div class="col-md-10">
					<div class="has-warning">
						<select id="selectLocked" data-rel="chosen"
							data-placeholder="用户状态" name="userFormMap.locked">
							<option value=""></option>
	...
	<script type="text/javascript">
		var sel = new myselect({
			...
			//width:$("#selectRole").parent().parent().css("width"),
			option_val : [ "id" ],
			option_val_prefix : ",",
			option_html : [ "name" ],
			option_html_prefix : ","
		...
		function _submit() {
			if ($("#form").form("validate")) {
				if($("#divshow").attr("class")=='has-error'){
					$("#accountName").focus();
				}else{
					$("#form").submit();
				}
		...
		function isExit(){
			$.ajax({
				...
				url:'${ctx}/user/isExsit.shtml',
				success:function(data){
					if(data == 'success'){
						layer.msg("用户已存在");
						$("#divshow").removeClass("has-warning");
						$("#divshow").addClass("has-error");
					}else{
						$("#divshow").removeClass("has-error");
						$("#divshow").addClass("has-warning");
					}
				}
			});
		}
