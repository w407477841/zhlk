						...
						<div class=" col-md-12">
							...
							<div class="form-group col-md-3">
									<select id="selectLocation" data-rel="chosen"
											...
											name="YingPanLuXiangJiFormMap.location_id" style="width:100%">
											<option value=""></option>
										</select>
								</div>
								<div class="form-group col-md-3">
									<input type="text" class="form-control"
										name="YingPanLuXiangJiFormMap.name" value="" placeholder="名称">
								</div>
							</form>
						</div>
						<div class=" col-md-12">
...
<!--/row-->
<script type="text/javascript" src="js/system/yingpanluxiangji/list.js"></script>
<script type="text/javascript">
