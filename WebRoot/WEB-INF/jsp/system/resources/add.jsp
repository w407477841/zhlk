...
<body style="background-color:#d9edf7">
	...
	<div class=" col-md-12">
		<form id="form" name="form" method="post"
			action="${ctx}/resources/add.shtml">
				...
				<div class="col-md-10">
					<div class="has-warning">
						<input type="text" class="form-control easyui-validatebox" missingMessage="请输入菜单名称 " data-options="required:true" id="name"
							name="resFormMap.name" value="" placeholder="请输入 ：菜单名称 ">
					</div>
				</div>
			</div>
			<div class="form-group col-md-6">
				...
				<div class="col-md-10">
					<div class="has-warning">
						<input type="text" class="form-control easyui-validatebox" missingMessage="请输入菜单url" data-options="required:true" id="resUrl"
							name="resFormMap.resUrl" value="" placeholder="请输入 ：菜单url 必填">
					</div>
				</div>
			</div>
			<div class="form-group col-md-6">
				...
				<div class="col-md-10">
					<div class="has-warning">
						<input type="text" class="form-control easyui-validatebox" missingMessage="请输入菜单Key" data-options="required:true" id="level"
							name="resFormMap.resKey" value="" placeholder="请输入 ：菜单Key 必填 ">
					</div>
				</div>
			</div>
			<div class="form-group col-md-6">
				...
				<div class="col-md-10">
					<div class="has-warning">
						<input type="text" class="form-control" id="level"
							name="resFormMap.level" value="" placeholder="请输入 ：排序顺序 ">
					</div>
				</div>
			</div>
			<div class="form-group col-md-6">
				...
				<div class="col-md-10">
					<div class="has-warning">
						<input type="text" class="form-control" id="level"
							name="resFormMap.description" value="" placeholder="请输入 ：菜单描述 ">
					</div>
				</div>
			</div>
			<div class="form-group col-md-6">
				...
				<div class="col-md-10">
					<div class="has-warning">
						<input type="text" class="form-control"
							name="resFormMap.icon" value="" placeholder="请输入 ：菜单图标 ">
					</div>
				</div>
			</div>
