  ...
  <div class="row">
    ...
    <div class="alert alert-info"> 
     <form class="form-inline" role="form" id="searchForm"name="searchForm">
      ...
      <input id="start" type="text" class=" inline laydate-icon  form-control " name="times"  placeholder="开始时间">
      <input id="start1" type="text" class=" inline laydate-icon  form-control " name="timee"  placeholder="截止时间">
