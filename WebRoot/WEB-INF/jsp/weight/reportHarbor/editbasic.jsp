...
<body style="background-color:#d9edf7">
	...
	<form id="form" name="form" method="post"
		action="${ctx}/reportHarbor/editBasic.shtml">
		...
		<div class=" col-md-12">
				...
				<div class="col-md-8">
					<div class="has-warning">
						<input type="text" class="form-control easyui-validatebox"
							validType="IDCard" invalidMessage="请输入正确的身份证号" id="idCard"
							value="${reportHarborFormMap.IDCard }"
							onblur="find_Message(this)" name="reportHarborFormMap.IDCard"
							placeholder="请输入 ：身份证" maxlength="18">
					</div>
				</div>
				<div class="col-md-2">
					<button type="button" class="btn btn-primary"
						onclick="ReadIDCard_onclick()">读卡</button>
				</div>
			</div>
			...
			<div class="form-group col-md-6">
				...
				<div class="col-md-10">
					<div class="has-warning">
						<input type="text" class="form-control easyui-validatebox"
							missingMessage="请输入单位" data-options="required:true" id="userName"
							value="${reportHarborFormMap.userName }"
							name="reportHarborFormMap.userName" placeholder="请输入 ：单位"
							maxlength="16">
					</div>
				</div>
			</div>
				...
				<div class="col-md-10">
					<div class="has-warning">
						<input type="text" class="form-control"
							value="${reportHarborFormMap.phoneNumber }" id="phoneNumber"
							onblur="find_Message(this)"
							name="reportHarborFormMap.phoneNumber" placeholder="请输入 ：联系电话"
							maxlength="16">
					</div>
				</div>
			</div>
				...
				<div class="col-md-10">
					<div class="has-warning">
						<input type="text" class="form-control" id="address"
							value="${reportHarborFormMap.address }" placeholder="请输入 ：联系地址"
							name="reportHarborFormMap.address" maxlength="64">
					</div>
				</div>
			</div>
			<div class="form-group col-md-6">
				...
				<div class="col-md-10">
					<div class="has-warning">
						<input type="text" class="form-control easyui-validatebox"
							missingMessage="请输入车船号" data-options="required:true"
							name="reportHarborFormMap.shipId"
							value="${reportHarborFormMap.shipId }" placeholder="请输入 ：车船号"
							maxlength="16">
					</div>
				</div>
			</div>
			<div class="form-group col-md-6">
				...
				<div class="col-md-10">
					<div class="has-warning">
						<input type="text" class="form-control easyui-validatebox"
							missingMessage="请输入报港日期" id="dateformat"
							data-options="required:true"
							name="reportHarborFormMap.reportDate"
							value="${reportHarborFormMap.reportDate }"
							placeholder="请输入 ：报港日期" maxlength="32">
					</div>
				</div>
			</div>
			<div class="form-group col-md-6">
				...
				<div class="col-md-10">
					<div class="has-warning">
						<select class="form-control" id="warehouseName"
							name="reportHarborFormMap.wId" data-rel="chosen"
				...
				<div class="col-md-10">
					<div class="has-warning">
						<input type="text" class="form-control" id="variety"
							name="reportHarborFormMap.grainVariety"
				...
				<div class="col-md-10">
					<div class="has-warning">
						<input type="text" class="form-control" id="property"
							name="reportHarborFormMap.grainProperty"
			...
			<div class="form-group col-md-6">
				...
				<div class="col-md-10">
					<div class="has-warning">
						<select class="form-control" id="usedCar"
							name="reportHarborFormMap.usedCar" data-rel="chosen"
							data-placeholder="请选择是否驳车">
							<c:if test="${reportHarborFormMap.usedCar == '1' }">
							<option value="2">不驳车</option>
							<option value="1" selected="selected">驳车</option>
							</c:if>
							<c:if test="${reportHarborFormMap.usedCar == '2' }">
							<option value="2" selected="selected">不驳车</option>
	...
	<script type="text/javascript">
		...
		var sel = new myselect({
			...
			option_html : [ "wName" ],
			option_html_prefix : ",",
			selected_val : '${reportHarborFormMap.wLocation }'
		}, function() {
			//给change事件添加方法
			$("#warehouseName").html("");
		...
		function findWarehouse(location) {
			new myselect({
				...
				option_html : [ "wName" ],
				option_html_prefix : ",",
				selected_val : '${reportHarborFormMap.wId }'
			}, function() {
				//给change事件添加方法
		...
		function find_variety_property(warehouse_id) {
			$
					.ajax({
						...
						success : function(data) {
							if (data != null) {
								if (data.variety == '${reportHarborFormMap.grainVariety}') {
	...
	<script type="text/javascript">
		...
		function open_select_layer(data) {
			...
			for (var i = 0; i < data.length; i++) {
				text += "<input type='radio' name='radioBox' value='"+i+"'>"
						+ data[i].cID + "-" + data[i].userName
						+ "</input></br>";
			}
			layer.confirm(text, {
				btn : [ '确定', '取消' ]
