...
<div class=" col-md-12"><div class=" col-md-6">  <h3 class="animated rubberBand">补录信息</h3> </div>   </div> 
<div class=" col-md-12"><div class=" col-md-6">  <h4 class="animated rubberBand">基础信息</h4> </div>   </div>
<form id="form" name="form" method="post" action="${ctx}/reportHarbor/additionalAdd.shtml">
...
<div class=" col-md-12"> 
  ...
  <div class="form-group col-md-6">
   ...
   <div class="col-md-10">
    <div class="has-warning">
    <input type="text" class="form-control easyui-validatebox" missingMessage="请输入车船号" data-options="required:true" name="reportHarborFormMap.shipId" placeholder="请输入 ：车船号" maxlength="16" >
   </div> 
   </div>
   </div> 
  <div class="form-group col-md-6">
  ...
  <div class="form-group col-md-6">
   ...
   <div class=" col-md-12"><div class=" col-md-12">  <h4 class="animated rubberBand">称重信息</h4> </div>
   <div class="form-group col-md-6">
      <div class="col-md-2 div_label">毛重(kg)<span>*</span></div>
   <div class="col-md-10">
    <div class="has-warning">
    <input type="text" class="form-control easyui-validatebox" missingMessage="请输入毛重" data-options="required:true" onkeyup="value=value.replace(/[^\-?\d.]/g,'')" onblur="validFloat(this)" name="reportHarborFormMap.grossWeight" placeholder="请输入 ：毛重(kg)" maxlength="8">
   </div> 
   </div>
   </div> 
    <div class="form-group col-md-6">
      <div class="col-md-2 div_label">皮重(kg)<span>*</span></div>
   <div class="col-md-10">
    <div class="has-warning">
    <input type="text" class="form-control easyui-validatebox" missingMessage="请输入皮重" data-options="required:true" onkeyup="value=value.replace(/[^\-?\d.]/g,'')" onblur="validFloat(this)" name="reportHarborFormMap.tare" placeholder="请输入 ：皮重(kg)" maxlength="8">
    </div> 
   </div>
   </div> 
   <div class="form-group col-md-6">
      <div class="col-md-2 div_label">报港员<span>*</span></div>
   <div class="col-md-10">
    <div class="has-warning">
    <input type="text" class="form-control easyui-validatebox" missingMessage="请输入报港员" data-options="required:true" placeholder="请输入 ：报港员" name="reportHarborFormMap.checker" maxlength="16">
    </div> 
   </div>
   </div> 
  <div class="form-group col-md-6">
      <div class="col-md-2 div_label">司磅员<span>*</span></div>
   <div class="col-md-10">
    <div class="has-warning">
    <input type="text" class="form-control easyui-validatebox" missingMessage="请输入司磅员" data-options="required:true" name="reportHarborFormMap.weightAuthor" placeholder="请输入 ：司磅员" maxlength="16" >
   </div> 
   </div>
   </div> 
  <div class="form-group col-md-6">
      <div class="col-md-2 div_label">报港日期<span>*</span></div>
   <div class="col-md-10">
    <div class="has-warning">
    <input type="text" class="form-control easyui-validatebox" missingMessage="请输入报港日期" data-options="required:true" id="dateformat" name="reportHarborFormMap.reportDate" placeholder="请输入 ：报港日期" >
   </div> 
   </div>
   </div> 
  <div class="form-group col-md-6">
      <div class="col-md-2 div_label">称重日期<span>*</span></div>
   <div class="col-md-10">
    <div class="has-warning">
    <input type="text" class="form-control easyui-validatebox" missingMessage="请输入称重日期" data-options="required:true" id="dateformat1" name="reportHarborFormMap.weightEndDate" placeholder="请输入 ：称重日期" >
   </div> 
   </div>
   </div> 
