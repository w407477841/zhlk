			...
			<div class="box-content" id="page">
				<div class="alert alert-info">
					<div class="row">
						...
						</a> <a class="btn btn-info" href="javascript:void(0)" id="check"
								style="text-shadow: black 5px 3px 3px;"> <i
								class="glyphicon glyphicon-check icon-white"></i> 质检
							</a>
						</div>
					</div>
				</div>
...
<script type="text/javascript"
	src="js/system/weight/reportHarbor/notchecklist.js"></script>
	<script type="text/javascript" src="js/LodopFuncs.js">
	</script>
   <script type="text/javascript"
		src="js/system/weight/print/qualityCheckPrint.js"></script>
<script type="text/javascript">
