					...
					<div class="row">
						...
						<div class=" col-md-12">
							<a class="btn btn-primary" href="javascript:void(0)" id="search"
								...
								style="text-shadow: black 5px 3px 3px;"> <i
								class="glyphicon glyphicon-plus icon-white"></i> 入库补录
							</a> <a class="btn btn-info" href="javascript:void(0)" id="outAddFun"
								style="text-shadow: black 5px 3px 3px;"> <i
								class="glyphicon glyphicon-plus icon-white"></i> 出库补录
...
<script type="text/javascript"
	src="js/system/weight/reportHarbor/additionallist.js"></script>
<script type="text/javascript">
