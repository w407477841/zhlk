				...
				<div class="box-content" id="page">
					...
					<div class="row">
						...
						<a class="btn btn-primary" href="javascript:void(0)" id="search"
							...
							id="createQCFun" style="text-shadow: black 5px 3px 3px;"> <i
							class="glyphicon glyphicon-export icon-white"></i> 打印二维码
						</a>
						</div>
						</div>
					</div>
...
<script type="text/javascript" src="js/system/weight/car/carlist.js"></script>
<script type="text/javascript">
