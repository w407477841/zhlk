								...
								<form id="searchForm" name="searchForm" method="post">
									...
									<div class="form-group col-md-3">
											<input type="text" class="form-control" id="dateformat1"
												name="reportHarborFormMap.payDate" placeholder="付款日期-开始">
									</div>
									<div class="form-group col-md-3">
											<input type="text" class="form-control" id="dateformat3"
												name="reportHarborFormMap.payDateEnd" placeholder="付款日期-结束">
									</div>
									<div class="form-group col-md-3">
...
<script type="text/javascript"
	src="js/system/weight/reportForms/twolist.js"></script>
<script type="text/javascript">
laydate({
	elem : '#dateformat',
	event : 'focus'
