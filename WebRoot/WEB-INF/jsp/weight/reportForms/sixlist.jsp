							...
							<div class=" col-md-12">
								<form id="searchForm" name="searchForm" method="post">
									<div class="form-group col-md-3">
											<select id="payPlanId" data-rel="chosen"
												data-placeholder="资金计划编号" name="reportHarborFormMap.payPlanId"
												style="width:100%">
												<option value=""></option>
											</select>
									</div>
...
<script type="text/javascript"
	src="js/system/weight/reportForms/sixlist.js"></script>
<script type="text/javascript">
...
//初始化库点下拉框
$("#payPlanId").html("");
$("#payPlanId").chosen("destroy");
new myselect({
	obj_id:"payPlanId",
	url:rootPath+"/zijinjihua/findAllZiJinJiHua.shtml",
	option_val:["bpBill"],
	option_val_prefix:",",
	option_html:["bpBill"],
	option_html_prefix:","
