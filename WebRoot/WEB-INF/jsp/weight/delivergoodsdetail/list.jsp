				...
				<div class="box-content" id="page">
					...
					<div class="row">
						...
						<form id="searchForm"
							...
							<input type="text" class="form-control" name="carFormMap.cId"
								value="" placeholder="合同编号">
								</div>
						</form>
						</div>
						<div class=" col-md-12">
						<a class="btn btn-primary" href="javascript:void(0)" id="search"
							...
							class="glyphicon glyphicon-open icon-white"></i> 文件上传
						</a> <a class="btn btn-primary" href="javascript:void(0)"
							id="download" style="text-shadow: black 5px 3px 3px;"> <i
							class="glyphicon glyphicon-save icon-white"></i> 文件下载
...
<script type="text/javascript" src="js/system/weight/delivergoodsdetail/list.js"></script>
<script type="text/javascript" src="js/LodopFuncs.js">
</script>
<script type="text/javascript"
	src="js/system/weight/print/deliverGoodsDetailPrint.js"></script>
<script type="text/javascript">
