...
<body style="background-color:#d9edf7">
	...
	<div class=" col-md-12">
		<form id="form" name="form" method="post"
			action="${ctx}/deliverGoodsDetail/add.shtml">
			...
			<div class="form-group col-md-6">
				...
				<div class="col-md-8">
					<div class="has-warning">
						<input type="text" class="form-control" name="deliverGoodsDetailFormMap.agreementBill"
			...
			<div class="form-group col-md-6">
				...
				<div class="col-md-8">
					<div class="has-warning">
						<input type="text" class="form-control" id="agreementName" name="deliverGoodsDetailFormMap.agreementName"
			...
			<div class="form-group col-md-6">
				...
				<div class="col-md-8">
					<div class="has-warning">
						<input type="text" class="form-control" id="getoutBill" name="deliverGoodsDetailFormMap.getoutBill"
			...
			<div class="form-group col-md-6">
				...
				<div class="col-md-8">
					<div class="has-warning">
						<input type="text" class="form-control" id="deliverGoodsName" name="deliverGoodsDetailFormMap.deliverGoodsName"
				...
				<div class="col-md-8">
					<div class="has-warning">
						<input type="text" class="form-control" placeholder="请输入 ：发货站(港)"
							name="deliverGoodsDetailFormMap.deliverGoodsStation" maxlength="128">
					</div>
				</div>
			</div>
			<div class="form-group col-md-6">
				...
				<div class="col-md-8">
					<div class="has-warning">
						<input type="text" class="form-control" id="deliverGoodsDate"
							name="deliverGoodsDetailFormMap.deliverGoodsDate" placeholder="请输入 ：发货日期"
							maxlength="16">
					</div>
				</div>
			</div>
				...
				<div class="col-md-8">
					<div class="has-warning">
						<input type="text" class="form-control" id="grainVariety"
							name="deliverGoodsDetailFormMap.grainVariety" placeholder="请输入 ：品种"
							maxlength="32">
					</div>
				</div>
			</div>
				...
				<div class="col-md-8">
					<div class="has-warning">
						<input type="text" class="form-control" id="warehouseName"
							name="deliverGoodsDetailFormMap.warehouseName" placeholder="请输入 ：仓号"
							maxlength="32">
					</div>
				</div>
			</div>
			<div class="form-group col-md-6">
				...
				<div class="col-md-8">
					<div class="has-warning">
						<input type="text" class="form-control" id="deliverGoodsNumberLower"
							name="deliverGoodsDetailFormMap.deliverGoodsNumberLower" placeholder="请输入 ：发货数量(小写)"
							maxlength="16" onkeyup="upperNumber(this,'1')">
					</div>
				</div>
			</div>
			<div class="form-group col-md-6">
				...
				<div class="col-md-8">
					<div class="has-warning">
						<input type="text" class="form-control" id="deliverGoodsNumberUpper"
							name="deliverGoodsDetailFormMap.deliverGoodsNumberUpper" placeholder="请输入 ：发货数量(大写)"
							maxlength="32">
					</div>
				</div>
			</div>
				...
				<div class="col-md-8">
					<div class="has-warning">
						<input type="text" class="form-control"
							name="deliverGoodsDetailFormMap.deliverGoodsPerson" placeholder="请输入 ：发货方经办人"
							maxlength="16">
					</div>
				</div>
			</div>
			...
			<div class="form-group col-md-6">
				...
				<div class="col-md-8">
					<div class="has-warning">
						<input type="text" class="form-control" name="deliverGoodsDetailFormMap.takeDeliveryName"
				...
				<div class="col-md-8">
					<div class="has-warning">
						<input type="text" class="form-control" placeholder="请输入 ：到货站(港)"
							name="deliverGoodsDetailFormMap.takeDeliveryStation" maxlength="128">
					</div>
				</div>
			</div>
			<div class="form-group col-md-6">
				...
				<div class="col-md-8">
					<div class="has-warning">
						<input type="text" class="form-control" id="takeDeliveryDate"
							name="deliverGoodsDetailFormMap.takeDeliveryDate" placeholder="请输入 ：收货日期"
							maxlength="16">
					</div>
				</div>
			</div>
			<div class="form-group col-md-6">
				...
				<div class="col-md-8">
					<div class="has-warning">
						<input type="text" class="form-control"
							name="deliverGoodsDetailFormMap.takeDeliveryNumberLower" placeholder="请输入 ：接收数量(小写)"
							maxlength="16" onkeyup="upperNumber(this,'2')">
					</div>
				</div>
			</div>
			<div class="form-group col-md-6">
				...
				<div class="col-md-8">
					<div class="has-warning">
						<input type="text" class="form-control" id="takeDeliveryNumberUpper"
							name="deliverGoodsDetailFormMap.takeDeliveryNumberUpper" placeholder="请输入 ：接收数量(大写)"
							maxlength="16">
					</div>
				</div>
			</div>
			<div class="form-group col-md-6">
				...
				<div class="col-md-8">
					<div class="has-warning">
						<input type="text" class="form-control"
							name="deliverGoodsDetailFormMap.tureLossNumber" placeholder="请输入 ：实际损耗量"
							maxlength="16">
					</div>
				</div>
			</div>
			<div class="form-group col-md-6">
				...
				<div class="col-md-8">
					<div class="has-warning">
						<input type="text" class="form-control"
							name="deliverGoodsDetailFormMap.overstepNumber" placeholder="请输入 ：超耗量"
							maxlength="16">
					</div>
				</div>
			</div>
			<div class="form-group col-md-6">
				...
				<div class="col-md-8">
					<div class="has-warning">
						<input type="text" class="form-control"
							name="deliverGoodsDetailFormMap.takeDeliveryPerson" placeholder="请输入 ：收货方经办人"
							maxlength="16">
					</div>
				</div>
			</div>
			...
			<div class="form-group col-md-6">
				...
				<div class="col-md-8">
					<div class="has-warning">
						<input type="text" class="form-control"
							name="deliverGoodsDetailFormMap.transportName" placeholder="请输入 ：运输单位"
							maxlength="128">
					</div>
				</div>
			</div>
			<div class="form-group col-md-6">
				...
				<div class="col-md-8">
					<div class="has-warning">
						<input type="text" class="form-control"
							name="deliverGoodsDetailFormMap.transportTool" placeholder="请输入 ：运输工具"
							maxlength="16">
					</div>
				</div>
			</div>
				...
				<div class="col-md-8">
					<div class="has-warning">
						<input type="text" class="form-control" id="carOrShipNo"
							name="deliverGoodsDetailFormMap.carOrShipNo" placeholder="请输入 ：车（船）号"
							maxlength="16">
					</div>
				</div>
			</div>
			<div class="form-group col-md-6">
				...
				<div class="col-md-8">
					<div class="has-warning">
						<input type="text" class="form-control"
							name="deliverGoodsDetailFormMap.transportBill" placeholder="请输入 ：运单号"
							maxlength="32">
					</div>
				</div>
			</div>
			<div class="form-group col-md-6">
				...
				<div class="col-md-8">
					<div class="has-warning">
						<input type="text" class="form-control"
							name="deliverGoodsDetailFormMap.transportLossRate" placeholder="请输入 ：定额运输损耗率"
							maxlength="16">
					</div>
				</div>
			</div>
			<div class="form-group col-md-6">
				...
				<div class="col-md-8">
					<div class="has-warning">
						<input type="text" class="form-control"
							name="deliverGoodsDetailFormMap.transportLossNumber" placeholder="请输入 ：定额损耗量"
							maxlength="16">
					</div>
				</div>
			</div>
			<div class="form-group col-md-6">
				...
				<div class="col-md-8">
					<div class="has-warning">
						<input type="text" class="form-control"
							name="deliverGoodsDetailFormMap.transportPerson" placeholder="请输入 ：运输方经办人"
							maxlength="16">
					</div>
				</div>
			</div>
					...
					if(data != null){
						...
						if(inOrOut == '1'){ //出库
							...
							if(totalWeight != null){//有称重信息
								...
								$("#takeDeliveryName").val(data.userName);
								$("#grainVariety").val(data.grainVariety);
								$("#warehouseName").val(data.wName);
								$("#carOrShipNo").val(data.shipId);
								$("#deliverGoodsName").val(data.companyName);
								$("#deliverGoodsNumberLower").val(data.totalWeight/1000);
								var obj = document.getElementById("deliverGoodsNumberLower");
								$("#deliverGoodsNumberUpper").val(chengeFloatToUpper(obj));
							}else{
								layer.msg("未进行称重或称重未完成！",{icon: 5});
								clear();
							}
						}else{
							layer.msg("此单据号为入库单据号！",{icon: 5});
							clear();
						}
					}else{
