...
var rootPath="${pageContext.servletContext.contextPath}";
  ...
  <div class="row">
    ...
    <div class="box-header well" data-original-title="">
        <h2><i class="glyphicon glyphicon-list"></i> 温度趋势图</h2>
        <div class="box-icon">
...
<script type="text/javascript" src="js/system/cangkuzhinenghuaxitong/liangqingjiankong/wenduqushilist.js"></script>
<script type="text/javascript">
