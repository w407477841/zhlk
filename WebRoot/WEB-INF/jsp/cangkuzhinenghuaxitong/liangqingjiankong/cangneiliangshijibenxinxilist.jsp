...
var rootPath="${pageContext.servletContext.contextPath}";
  ...
  <div class="row">
    ...
    <div class="box-header well" data-original-title="">
        <h2><i class="glyphicon glyphicon-list"></i> 仓内粮食基本信息</h2>
        <div class="box-icon">
...
<script type="text/javascript" src="js/system/cangkuzhinenghuaxitong/liangqingjiankong/cangneiliangshijibenxinxilist.js"></script>
<script type="text/javascript">
