...
<body style="background-color:#d9edf7">
	...
	<div class=" col-md-12 ">
		<form id="form" class="form-horizontal" name="form" method="post" action="${ctx}/cangkuzhinenghuaxitong/ammeterConfig/add.shtml">
		<input type="hidden" name="token" value="${token}" />
				
				<div class="form-group">
				<label for="name" class="col-sm-2 control-label">电表名称</label>
				<div class="col-sm-6">
						<input type="text" class="form-control" id="name"name="ammeterConfigFormMap.name" value="" placeholder="请输入 ：电表名称">
				</div>
	 ...
	 <div class="col-sm-6">
   	...
   	<option value=""></option>
   		...
   		<p class="help-block col-sm-4">选择粮站</p>	
				...
				<div class="col-sm-6">
						<input type="text" class="form-control" id="ipNum"name="ammeterConfigFormMap.ip" value=""placeholder="请输入 ：ip">
						</div>
				...
				<div class="col-sm-6">
						<input type="text" class="form-control" id="sLeft"name="ammeterConfigFormMap.port" value=""placeholder="请输入 ：端口号">
				</div>
			...
			<div class="form-group">
				<label for="close1" class="col-sm-2 control-label">指令</label>
					<div class="col-sm-6">
						<input type="text" class="form-control" id="instructions"name="ammeterConfigFormMap.instructions" value="" placeholder="查询指令">
					</div>
