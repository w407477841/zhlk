...
var rootPath="${pageContext.servletContext.contextPath}";
  ...
  <div class="row">
    ...
    <div class="box-header well" data-original-title="">
        <h2><i class="glyphicon glyphicon-facetime-video"></i>按月份</h2>
...
<script type="text/javascript" src="${pageContext.servletContext.contextPath}/js/system/cangkuzhinenghuaxitong/ammeterdata/findMonList.js"></script>
<script type="text/javascript">
