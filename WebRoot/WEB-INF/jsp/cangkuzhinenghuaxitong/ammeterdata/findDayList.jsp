...
var rootPath="${pageContext.servletContext.contextPath}";
  ...
  <div class="row">
    ...
    <div class="box-header well" data-original-title="">
        <h2><i class="glyphicon glyphicon-facetime-video"></i>按日期</h2>
...
<div class="alert alert-warning alert-dismissible" role="alert">
  ...
  <strong>默认查询</strong> 最近30天能耗
</div>



    		<a class="btn btn-primary" href="javascript:search(1)" id="search1" style="text-shadow: black 5px 3px 3px;">
                <i class="glyphicon glyphicon-search icon-white" ></i>
               		能耗
            	</a>  
            <a class="btn btn-primary" href="javascript:search(2)" id="search2" style="text-shadow: black 5px 3px 3px;">
                <i class="glyphicon glyphicon-search icon-white" ></i>
               		读数
            	</a>  	
...
<script type="text/javascript" src="${pageContext.servletContext.contextPath}/js/system/cangkuzhinenghuaxitong/ammeterdata/findDayList.js"></script>
<script type="text/javascript">
