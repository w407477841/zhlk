	...
	<div class="box col-md-12"
		...
		<div class="box-inner">
			<div class="box-header well" data-original-title="">
				<h2>
					<i class="glyphicon glyphicon-user"></i> <span id="pageTitle"></span>
				</h2>
			</div>
							...
							<form id="searchForm" name="searchForm">
								<div class="form-group col-md-3">
									<input type="text" class="form-control"
										name="userLoginLogFormMap.accountName" value=""
										placeholder="账户名称">
								</div>
								<div class="form-group col-md-3">
									<input type="text" class="form-control"
										name="userLoginLogFormMap.loginIP" value=""
										placeholder="登录IP">
								</div>
								<div class="form-group col-md-3">
									<input type="text" class="form-control"
										name="userLoginLogFormMap.description" value=""
										placeholder="登录状态">
								</div>
							</form>
						</div>
...
<!--/row-->
<script type="text/javascript" src="js/loginlog/list.js"></script>
<script type="text/javascript">
