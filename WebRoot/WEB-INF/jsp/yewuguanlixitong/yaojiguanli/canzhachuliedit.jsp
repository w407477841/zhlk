...
<body style="background-color:#d9edf7">
	...
	<div class=" col-md-12">
		<form id="form" name="form" method="post"
			action="${ctx}/canzhachuli/edit.shtml">
			<input type="hidden" name="canZhaChuLiFormMap.id"
				value="${canZhaChuLiFormMap.id }"> <input type="hidden"
				name="canZhaChuLiFormMap.version"
				value="${canZhaChuLiFormMap.version }"> <input type="hidden"
				...
				<div class="col-md-10">
					<div class="has-warning">
						<input type="text" class="form-control easyui-validatebox" missingMessage="请输入空瓶数量" data-options="required:true"
							...
							value="${canZhaChuLiFormMap.mdNumber }" placeholder="请输入 ：空瓶数量"
							maxlength="9">
					</div>
				</div>
			</div>
				...
				<div class="col-md-10">
					<div class="has-warning">
						<input type="text" class="form-control easyui-validatebox" missingMessage="请输入熏蒸日期" data-options="required:true" id="dateformat1"
							...
							value="${canZhaChuLiFormMap.mdFumigateDate}">
					</div>
				</div>
			</div>
			<div class="form-group col-md-6">
				...
				<div class="col-md-10">
					<div class="has-warning">
						<input type="text" class="form-control  easyui-validatebox" missingMessage="请输入开启日期" data-options="required:true" id="dateformat"
							...
							value="${canZhaChuLiFormMap.mdBeginDate}">
					</div>
				</div>
			</div>
				...
				<div class="col-md-11">
					<div class="has-warning">
						<textarea rows="4" cols="20" class="form-control easyui-validatebox" missingMessage="请输入参与人员" data-options="required:true"
							...
							maxlength="64">${canZhaChuLiFormMap.mdParticipant}</textarea>
					</div>
				</div>
			</div>
			<div class="form-group col-md-12">
				...
				<div class="col-md-11">
					<div class="has-warning">
						<textarea rows="4" cols="20" class="form-control easyui-validatebox" missingMessage="请输入处理方式" data-options="required:true"
							...
							maxlength="128">${canZhaChuLiFormMap.mdProcessMode}</textarea>
					</div>
				</div>
			</div>
			<div class="form-group col-md-12">
	...
	<script type="text/javascript">
		...
		var sel = new myselect({
			...
			option_html : [ "wName" ],
			option_html_prefix : ",",
			selected_val : ${canZhaChuLiFormMap.wLocation}
		}, function() {
			//给change事件添加方法
			$("#warehouseName").html("");
		...
		function findWarehouse(location) {
			new myselect({
				...
				option_html : [ "wName" ],
				option_html_prefix : ",",
				selected_val : ${canZhaChuLiFormMap.mdWarehouseId}
			}, function() {
				//给change事件添加方法
			}, function() {
				//初始化执行方法
