							...
							<form id="searchForm" name="searchForm">
								<div class="form-group col-md-3">
									<select id="selectLocation" data-rel="chosen"
											...
											name="canZhaChuLiFormMap.wlNo" style="width:100%">
											<option value=""></option>
										</select>
								</div>
								<div class="form-group col-md-3">
										<select class="form-control" id="warehouse"
											name="canZhaChuLiFormMap.wNo" data-rel="chosen"
											data-placeholder="仓号">
										</select>
								</div>
							</form>
...
<!--/row-->
<script type="text/javascript"
	src="js/system/yewuguanlixiytong/yaojiguanli/canzhachulilist.js"></script>
<script type="text/javascript">
