							...
							<form id="searchForm" name="searchForm">
								<div class="form-group col-md-3">
									<input type="text" class="form-control"
										name="yaoJiLingYongFormMap.muName" value="" placeholder="药剂名称">
								</div>
							</form>
						</div>
						<div class=" col-md-12">
							...
							</a> <a class="btn btn-primary" href="javascript:void(0)" id="viewFun"
								style="text-shadow: black 5px 3px 3px;"> <i
...
<!--/row-->
<script type="text/javascript"
	src="js/system/yewuguanlixiytong/yaojiguanli/yaojilingyongguanlilist.js"></script>
<script type="text/javascript">
