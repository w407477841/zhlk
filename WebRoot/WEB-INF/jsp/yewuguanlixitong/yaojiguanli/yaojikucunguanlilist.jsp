							...
							<form id="searchForm" name="searchForm">
								<div class="form-group col-md-3">
									<input type="text" class="form-control"
										name="yaoJiKuCunFormMap.mrName" value="" placeholder="药剂名称">
								</div>
							</form>
						</div>
						<div class=" col-md-12">
							<a class="btn btn-primary" href="javascript:void(0)" id="search"
								...
								id="increaseFun" style="text-shadow: black 5px 3px 3px;"> <i
								class="glyphicon glyphicon-import icon-white"></i> 续增已有药剂
							...
							</a> <a class="btn btn-primary" href="javascript:void(0)" id="useFun"
								style="text-shadow: black 5px 3px 3px;"> <i
								class="glyphicon glyphicon-share-alt icon-white"></i> 领用
							</a>
						</div>
					</div>
				</div>
...
<script type="text/javascript"
	src="js/system/yewuguanlixiytong/yaojiguanli/yaojikucunguanlilist.js"></script>
<script type="text/javascript">
