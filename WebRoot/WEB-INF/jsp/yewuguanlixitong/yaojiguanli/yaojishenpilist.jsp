			...
			<div class="box-inner">
				...
				<div class="box-content" id="page">
					...
					<div class="row">
							...
							<form id="searchForm" name="searchForm">
								<div class="form-group col-md-3">
									<input type="text" class="form-control"
										name="yaoJiShenQingFormMap.maName" value="" placeholder="药剂名称">
								</div>
							</form>
						</div>
						<div class=" col-md-12">
						...
						</a> <a class="btn btn-info" href="javascript:void(0)" id="audFun"
							style="text-shadow: black 5px 3px 3px;"> <i
							class="glyphicon glyphicon-ok icon-white"></i> 审批
						</a>
						</div>
						</div>
					</div>
...
<script type="text/javascript"
	src="js/system/yewuguanlixiytong/yaojiguanli/yaojishenpilist.js"></script>
<script type="text/javascript">
