...
<body style="background-color:#d9edf7">
	...
	<div class=" col-md-12">
		<form id="form" name="form" method="post"
			action="${ctx}/yaojikucunguanli/edit.shtml">
				...
				<div class="col-md-10">
					<div class="has-warning">
						<input type="text" class="form-control easyui-validatebox"
							...
							value="${yaoJiKuCunFormMap.mrNumber }" placeholder="请输入 ：药剂数量"
							disabled="disabled" maxlength="6"> <input type="hidden"
			...
			<div class="form-group col-md-6">
				...
				<div class="col-md-10">
					<div class="has-warning">
						<input type="text" class="form-control easyui-validatebox"
							missingMessage="请输入生产日期" data-options="required:true"
							id="dateformat" placeholder="请输入 ：生产日期"
				...
				<div class="col-md-11">
					<div class="has-warning">
						<input type="text" class="form-control"
							...
							placeholder="请输入 ：生产厂家" maxlength="128">
					</div>
				</div>
			</div>
			<div class="form-group col-md-6">
				...
				<div class="col-md-11">
					<div class="has-warning">
						<textarea rows="4" cols="20" class="form-control"
							...
							maxlength="256">${yaoJiKuCunFormMap.mrRemark }</textarea>
					</div>
				</div>
			</div>
	...
	<script type="text/javascript">
		...
		var sel = new myselect({
			...
			option_html : [ "wName" ],
			option_html_prefix : ",",
			selected_val : ${yaoJiKuCunFormMap.mrWLNo}
		}, function() {
			//给change事件添加方法
		}, function() {
			//初始化执行方法
		...
		var sele = new myselect({
			...
			option_html : [ "text" ],
			option_html_prefix : ",",
			selected_val : ${yaoJiKuCunFormMap.mrDrug}
		}, function() {
			//给change事件添加方法
		}, function() {
			//初始化执行方法
		...
		var sele = new myselect({
			...
			option_html : [ "text" ],
			option_html_prefix : ",",
			selected_val : ${yaoJiKuCunFormMap.mrPage}
		}, function() {
			//给change事件添加方法
		}, function() {
			//初始化执行方法
