...
<body style="background-color:#d9edf7">
	...
	<form id="form" name="form" method="post"
		action="${ctx}/qualityManager/addQualityCheck.shtml">
		<input type="hidden" name="token" value="${token }"> <input
			type="hidden" name="qualityManagerFormMap.qualityType" value="3">
		<div class=" col-md-12">
				...
				<div class="col-md-10">
					<div class="has-warning">
						<input type="text" class="form-control" id="variety"
							name="qualityManagerFormMap.grainVariety" readonly="readonly">
					</div>
				</div>
			</div>
			<div class="form-group col-md-6">
				...
				<div class="col-md-10">
					<div class="has-warning">
						<input type="text" class="form-control"
							name="qualityManagerFormMap.grainOwnership" placeholder="请输入：粮权归属" maxlength="32">
					</div>
				</div>
			</div>
			<div class="form-group col-md-6">
				...
				<div class="col-md-10">
					<div class="has-warning">
						<input type="text" class="form-control"
							name="qualityManagerFormMap.managerWay" placeholder="请输入：管理方式" maxlength="32">
					</div>
				</div>
			</div>
			<div class="form-group col-md-6">
				...
				<div class="col-md-10">
					<div class="has-warning">
						<input type="text" class="form-control"
							name="qualityManagerFormMap.putinWay" placeholder="请输入：入仓方式" maxlength="32">
					</div>
				</div>
			</div>
			<div class="form-group col-md-6">
			...
			<div class="form-group col-md-6">
				...
				<div class="col-md-10">
					<div class="has-warning">
						<input type="text" class="form-control easyui-validatebox" missingMessage="请输入收获年度" data-options="required:true" id="dateformat"
							name="qualityManagerFormMap.buyYear" placeholder="请输入：收获年度">
					</div>
				</div>
			</div>
			<div class="form-group col-md-6">
				<div class="col-md-2 div_label">检测日期<span>*</span></div>
				<div class="col-md-10">
					<div class="has-warning">
						<input type="text" class="form-control easyui-validatebox" missingMessage="请输入检测日期" data-options="required:true" id="dateformat1"
							name="qualityManagerFormMap.checkDate" placeholder="请输入：检测日期">
					</div>
				</div>
			</div>
			<div class="form-group col-md-12">
				...
				<div class="col-md-11">
					<div class="has-warning">
					 <textarea rows="4" cols="20" class="form-control" name="qualityManagerFormMap.remark" placeholder="请输入：摘要/备注"></textarea>
					</div>
				</div>
			</div>
		</div>
