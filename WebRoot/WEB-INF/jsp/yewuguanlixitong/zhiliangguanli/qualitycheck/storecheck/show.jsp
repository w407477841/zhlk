...
<html>
 ...
 $("#content").html(loadingImg());
  $.ajax({
		url : rootPath+"/qualityManager/export.shtml",
		type : 'post',
		dataType : 'html',
  ...
  $("#pdf").click("click",function(){
	  var pId = '${pId}';
	  window.open(rootPath+"/qualityManager/export.shtml?pId="+pId+"&showType=pdf");
  });
  $("#excel").click("click",function(){
	  var pId = '${pId}';
	  window.open(rootPath+"/qualityManager/export.shtml?pId="+pId+"&showType=excel");
  });
  $("#word").click("click",function(){
	  var pId = '${pId}';
	  window.open(rootPath+"/qualityManager/export.shtml?pId="+pId+"&showType=word");
  });
