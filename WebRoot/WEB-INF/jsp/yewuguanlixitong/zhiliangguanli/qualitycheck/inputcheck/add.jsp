...
<div class=" col-md-12"><div class=" col-md-6">  <h3 class="animated rubberBand">入库统仓信息</h3> </div>   </div> 
<div class=" col-md-12"><div class=" col-md-6">  <h4 class="animated rubberBand">基础信息</h4> </div>   </div>
<form id="form" name="form" method="post" action="${ctx}/qualityManager/addQualityCheck.shtml">
<input type="hidden" name="token" value="${token }">
<input type="hidden" name="qualityManagerFormMap.qualityType" value="2">
<div class=" col-md-12"> 
  ...
  <div class="form-group col-md-6">
   ...
   <div class="col-md-10">
   <div class="has-warning">
	<input type="text" class="form-control" id="dateformat" name="qualityManagerFormMap.buyYear" placeholder="请输入：收获年度">	
   </div>  
   </div>
   </div>   
   <div class="form-group col-md-6">
   ...
   <div class="col-md-10">
   <div class="has-warning">
	<input type="text" class="form-control" id="dateformat1" name="qualityManagerFormMap.checkDate" placeholder="请输入：检测日期">	
   </div>  
   </div>
   </div>   
  	</div>
