...
var rootPath="${pageContext.servletContext.contextPath}";
  ...
  <div class="row">
    ...
    <div class="box-header well" data-original-title="">
        <h2><i class="glyphicon glyphicon-list"></i> 粮油入库检验记录</h2>
        <div class="box-icon">
...
<script type="text/javascript" src="js/system/yewuguanlixiytong/zhiliangguanli/zhiliangjiance/liangyourukujianyanlist.js"></script>
<script type="text/javascript">
