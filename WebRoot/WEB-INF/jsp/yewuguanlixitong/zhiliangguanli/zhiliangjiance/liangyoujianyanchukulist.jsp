...
display: block;
  ...
  <div class="row">
    ...
    <div class="box-header well" data-original-title="">
        <h2><i class="glyphicon glyphicon-list"></i> 粮油检验出库统仓记录</h2>
        <div class="box-icon">
    ...
    <div class="alert alert-info"> 
     <form class="form-inline clear-float" role="form" id="searchForm"
			...
			<select id="location" data-rel="chosen" name="InstanceMsgFormMap.location"  data-placeholder="库点名称" >
				<option value="" selected="selected"> </option>
			</select>
			</div>
			
			<div style="width: 120px;float: left;">
			<select id="storageID" data-rel="chosen" name="InstanceMsgFormMap.houseid"  data-placeholder="所属仓库" >
				<option value="" selected="selected"> </option>
			</select>
			</div>
...
<script type="text/javascript" src="js/system/yewuguanlixiytong/zhiliangguanli/zhiliangjiance/liangyoujianyanchukulist.js"></script>
<script type="text/javascript">
