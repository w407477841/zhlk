...
<body style="background-color:#d9edf7">
	<div class=" col-md-12">
		<form id="form" name="form" method="post" action="${ctx}/kucunzhiliangjiance/addInstanceMsg.shtml">
			<input type="hidden" name="token" value="${token}">
			
			<input type="hidden" name="InstanceMsgFormMap.inorout" value="2"> </input>
				...
				<div class="form-group col-md-6">
					...
					<div class="col-md-9">
						<div class="has-warning">
							...
							name="InstanceMsgFormMap.property" readonly="readonly"    value="" placeholder="粮食性质">
						</div>
					</div>
				</div>
	...
	<div class="form-group col-md-12" style="border: 1px dashed; padding: 10px;margin: 10px 0">
		...
		<div class=" col-md-6">
			...
			<div class="form-group col-md-4">
					<div class="col-md-3 div_label">面筋吸水率:</div>
					<div class="col-md-9">
						<div class="has-warning">
							<input type="text" class=" form-control "name="InstorageQualityFormMap.Smj"  value="" placeholder="面筋吸水率">
						</div>
					</div>
				</div>
				
			<div class="form-group col-md-4">
					<div class="col-md-3 div_label">品尝评分值:</div>
					<div class="col-md-9">
						<div class="has-warning">
							<input type="text" class=" form-control "name="InstorageQualityFormMap.Pcpf"  value="" placeholder="品尝评分值">
						</div>
					</div>
				</div>
				<div class="form-group col-md-4">
			...
			<div class="form-group col-md-12" style="text-align: center;">
				<button type="button" class="btn btn-info bt-disabled"onclick="_submit()">提交</button>
			</div>
		</form>
	</div>
