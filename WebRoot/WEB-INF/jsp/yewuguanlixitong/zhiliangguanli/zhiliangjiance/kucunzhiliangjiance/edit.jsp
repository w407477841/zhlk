...
<body style="background-color:#d9edf7">
	...
	<div class=" col-md-12">
		<form id="form" name="form" method="post" action="${ctx}/kucunzhiliangjiance/editInstanceMsg.shtml">
		...
		<div class=" col-md-6">
			<h3 class="animated rubberBand">质检信息</h3>
				...
				<div class="form-group col-md-4">
					...
					<div class="col-md-9">
						<div class="has-warning">
							<input type="text" class=" form-control "name="InstorageQualityFormMap.Smj"  value="${InstanceMsgFormMap.Smj}" placeholder="面筋吸水率">
						</div>
					</div>
				</div>
			...
			<div class="form-group col-md-4">
					...
					<div class="col-md-9">
						<div class="has-warning">
							<input type="text" class=" form-control "name="InstorageQualityFormMap.Pcpf"  value="${InstanceMsgFormMap.Pcpf}" placeholder="品尝评分值">
						</div>
					</div>
				</div>
