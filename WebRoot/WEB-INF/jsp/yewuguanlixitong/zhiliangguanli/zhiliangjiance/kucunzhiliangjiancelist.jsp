...
display: block;
  ...
  <div class="row">
    ...
    <div class="box-header well" data-original-title="">
        <h2><i class="glyphicon glyphicon-list"></i> 库存质量检测记录</h2>
        <div class="box-icon">
...
<script type="text/javascript" src="js/system/yewuguanlixiytong/zhiliangguanli/zhiliangjiance/kucunzhiliangjiancelist.js"></script>
<script type="text/javascript">
