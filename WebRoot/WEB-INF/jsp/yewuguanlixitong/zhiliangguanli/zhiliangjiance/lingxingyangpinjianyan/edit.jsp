...
<body style="background-color:#d9edf7">
	...
	<div class=" col-md-12">
		<form id="form" name="form" method="post" action="${ctx}/lingxingyangpinjianyan/editInstanceMsg.shtml">
			...
			<input type="hidden" class="temp" name="" value="${InstanceMsgFormMap.breed}">
			<input type="hidden" class="temp" name="" value="${InstanceMsgFormMap.property}">
			...
			<h3 class="animated rubberBand">基础信息</h3>
					...
					<div class="col-md-9">
						<div class="has-warning">
							<input type="text" class=" form-control "name="InstanceMsgFormMap.source"  value="${InstanceMsgFormMap.source}" placeholder="样品来源">
						</div>
					</div>
				</div>		
								<div class="form-group col-md-6">
					...
					<div class="col-md-9">
						<div class="has-warning">
							<input id="amounts" type="text" class=" form-control " 
								name="InstanceMsgFormMap.amounts" value="${InstanceMsgFormMap.amounts}" placeholder="代表数量">
						</div>
					</div>
				</div>
