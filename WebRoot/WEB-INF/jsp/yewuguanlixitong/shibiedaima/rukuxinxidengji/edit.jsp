...
<body style="background-color:#d9edf7">
	<div class=" col-md-12">
		<form id="form" name="form" method="post" action="${ctx}/rukuxinxidengji/edit.shtml">
			<input type="hidden" name="token" value="${token}">
			<input type="hidden" name="InRegisterFormMap.id" value="${InRegisterFormMap.id}"> 
			
			<input type="hidden" class="temp" name="" value="${InRegisterFormMap.storageWay}">
			<input type="hidden" class="temp" name="" value="${InRegisterFormMap.breed}">
			<input type="hidden" class="temp" name="" value="${InRegisterFormMap.property}">
			<input type="hidden" class="temp" name="" value="${InRegisterFormMap.level}">
			...
			<h3 class="animated rubberBand">基础信息</h3>
					...
					<div class="col-md-9">
						<div class="has-warning">
							<input id="" type="text" class=" form-control " 
								name="InRegisterFormMap.code" value="${InRegisterFormMap.code}" placeholder="货位代码">
						</div>
					</div>
				</div>	
				...
				<div class="form-group col-md-6">
					...
					<div class="col-md-9">
						<div class="has-warning">
							<input id="" type="text" class=" form-control " 
								name="InRegisterFormMap.codeName" value="${InRegisterFormMap.codeName}" placeholder="货位名称">
						</div>
					</div>
				</div>
					...
					<div class="col-md-9">
						<div class="has-warning">
							<input id="start" type="text" class=" inline laydate-icon  form-control " 
								name="InRegisterFormMap.bornDate" value="${InRegisterFormMap.bornDate}" placeholder="生成时间">
						</div>
					</div>
				</div>	
					...
					<div class="col-md-9">
						<div class="has-warning">
							<input id="amounts" type="text" class=" form-control " 
								name="InRegisterFormMap.amounts" value="${InRegisterFormMap.amounts}" placeholder="数量">
						</div>
					</div>
				</div>
				...
				<div class="form-group col-md-6">
					...
					<div class="col-md-9">
						<div class="has-warning">
							<input id="" type="text" class=" form-control " 
								name="InRegisterFormMap.institution" value="${InRegisterFormMap.institution}" placeholder="粮权归属机构">
						</div>
					</div>
				</div>
				...
				<div class="form-group col-md-6">
					...
					<div class="col-md-9">
						<div class="has-warning">
							<input id="" type="text" class=" form-control " 
								name="InRegisterFormMap.bornPlace" value="${InRegisterFormMap.bornPlace}" placeholder="产地名称">
						</div>
					</div>
				</div>
				...
				<div class="form-group col-md-6">
					...
					<div class="col-md-9">
						<div class="has-warning">
							<input id="" type="text" class=" form-control " 
								name="InRegisterFormMap.bornYear" value="${InRegisterFormMap.bornYear}" placeholder="年份">
						</div>
					</div>
				</div>
					...
					<div class="col-md-9">
						<div class="has-warning">
							<input id="start1" type="text" class=" inline laydate-icon  form-control " 
								name="InRegisterFormMap.inDate" value="${InRegisterFormMap.inDate}" placeholder="入库时间">
						</div>
					</div>
				</div>
