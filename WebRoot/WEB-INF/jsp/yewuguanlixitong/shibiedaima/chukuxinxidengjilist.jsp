				...
				<div class="box-content" id="page">
					...
					<div class="row">
						...
						<form id="searchForm"
							...
							<input type="text" class="form-control" name="OutRegisterFormMap.wName"
								value="" placeholder="粮库地点">
								</div>
						</form>
						</div>
						<div class=" col-md-12">
						...
						<a class="btn btn-info" href="javascript:void(0)" id="add"
							style="text-shadow: black 5px 3px 3px;"> <i
						...
						</a> <a class="btn btn-danger" href="javascript:void(0)" id="remove"
							style="text-shadow: black 5px 3px 3px;"> <i
...
<script type="text/javascript"
	src="js/system/yewuguanlixiytong/shibiedaima/chukuxinxidengjilist.js"></script>
<script type="text/javascript">
