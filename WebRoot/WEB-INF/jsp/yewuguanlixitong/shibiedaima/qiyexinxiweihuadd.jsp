...
<body style="background-color:#d9edf7">
	...
	<div class=" col-md-12">
		<div class=" col-md-6">
			<h3 class="animated rubberBand">企业信息</h3>
		</div>
	</div>
	<div class='col-md-12'>
		<form class="form-horizontal" id="form" name="form" method="post"
			action="${ctx}/qiyexinxiweihu/add.shtml">
			<div class="form-group col-md-6">
				<div class="col-md-3 div_label">企业名称</div>
				<div class="col-md-9">
					<div class="has-warning">
						<input type="text" class="form-control" id="eName"
							name="enterpriseFormMap.eName" placeholder="请输入：企业名称" maxlength="40">
					</div>
				</div>
			</div>
			<div class="form-group col-md-6">
				...
				<div class="col-md-9">
					<div class="has-warning">
						<input type="text" class="form-control" id="eGroupCode"
							name="enterpriseFormMap.eGroupCode" placeholder="请输入：组织机构代码" maxlength="20">
					</div>
				</div>
			</div>
			<div class="form-group col-md-6">
				...
				<div class="col-md-9">
					<div class="has-warning">
						<input type="text" class="form-control" id="eAddrCode"
							name="enterpriseFormMap.eAddrCode" placeholder="请输入：行政区划代码" maxlength="20">
					</div>
				</div>
			</div>
				...
				<div class="col-md-9">
					<div class="has-warning">
						<input type="text" class="form-control" id="eNature"
							name="enterpriseFormMap.eNature" placeholder="请输入：企业性质" maxlength="10">
					</div>
				</div>
			</div>
			<div class="form-group col-md-6">
				...
				<div class="col-md-9">
					<div class="has-warning">
						<input type="text" class="form-control" id="eClassify"
							name="enterpriseFormMap.eClassify" placeholder="请输入：企业经营种类" maxlength="10">
					</div>
				</div>
			</div>
			<div class="form-group col-md-6">
				...
				<div class="col-md-9">
					<div class="has-warning">
						<input type="text" class="form-control" id="eLocation"
							name="enterpriseFormMap.eLocation" placeholder="请输入：联系地址" maxlength="40">
					</div>
				</div>
			</div>
			<div class="form-group col-md-6">
				...
				<div class="col-md-9">
					<div class="has-warning">
						<input type="text" class="form-control" id="ePerson"
							name="enterpriseFormMap.ePerson" placeholder="请输入：法人名称" maxlength="20">
					</div>
				</div>
			</div>
				...
				<div class="col-md-9">
					<div class="has-warning">
						<input type="text" class="form-control" id="ePhone"
							name="enterpriseFormMap.ePhone" placeholder="请输入：联系电话" maxlength="20">
					</div>
				</div>
			</div>
				...
				<div class="col-md-9">
					<div class="has-warning">
						<input type="text" class="form-control" id="eCredit"
							name="enterpriseFormMap.eCredit" placeholder="请输入：资信情况" maxlength="20">
					</div>
				</div>
			</div>
