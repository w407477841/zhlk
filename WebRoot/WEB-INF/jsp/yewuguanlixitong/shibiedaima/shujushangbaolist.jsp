				...
				<div class="box-content" id="page">
					...
					<div class="row">
						...
						<form id="searchForm"
							...
							<input type="text" class="form-control" name="userLoginLogFormMap.accountName"
						...
						<a class="btn btn-info" href="javascript:void(0)" id="search"
							style="text-shadow: black 5px 3px 3px;"> <i
							class="glyphicon glyphicon-plus icon-white"></i> 新增
						</a> <a class="btn btn-warning" href="javascript:void(0)" id="search"
							style="text-shadow: black 5px 3px 3px;"> <i
							class="glyphicon glyphicon-edit icon-white"></i> 修改
						</a> <a class="btn btn-danger" href="javascript:void(0)" id="search"
							style="text-shadow: black 5px 3px 3px;"> <i
...
<script type="text/javascript"
	src="js/system/yewuguanlixiytong/shibiedaima/shujushangbaolist.js"></script>
<script type="text/javascript">
