...
<body style="background-color:#d9edf7">
	...
	<div class=" col-md-12">
		<form id="form" name="form" method="post"
			action="${ctx}/businessManager/editJiakongPlan.shtml">
			<input type="hidden" name="token" value="${token}"> 
			<input type="hidden" name="BusinessPlanForMapJiakong.id" value="${BusinessPlanForMapJiakong.id}"> 
			...
			<div class="form-group col-md-6">
					...
					<div class="col-md-10">
						<div class="has-warning">
							<select id="selectCk" data-rel="chosen"
								data-placeholder="请选择仓号" name="BusinessPlanForMapJiakong.wId">
								<option value=""></option>
							</select>
						</div>
					</div>
				...
				<div class="form-group col-md-6">
					...
					<div class="col-md-10">
						...
						<input id="varietyId" type="hidden" name="BusinessPlanForMapJiakong.breed">
						</div>
					</div>
				</div>

				<div class="form-group col-md-6">
					<div class="col-md-2 div_label">粮食性质<span>*</span></div>
					<div class="col-md-10">
						<div class="has-warning">
							<input id="propertyName" type="text" readonly="readonly" class="form-control">
						<input id="propertyId" type="hidden" name="BusinessPlanForMapJiakong.property">
						</div>
					</div>
				</div>
				...
				<div class="form-group col-md-6">
					...
					<div class="col-md-10">
						<div class="has-warning">
							<input id="beginDate" type="text" class="form-control easyui-validatebox" missingMessage="请输入开始时间" data-options="required:true"
								name="BusinessPlanForMapJiakong.timestart"
								placeholder="请输入：开始时间" value="${BusinessPlanForMapJiakong.timestart }">
						</div>
					</div>
				</div>
				...
				<div class="form-group col-md-6">
					...
					<div class="col-md-10">
						<div class="has-warning">
							<input id="endDate" type="text" class="form-control easyui-validatebox" missingMessage="请输入结束时间" data-options="required:true"
								name="BusinessPlanForMapJiakong.timeend" 
								value="${BusinessPlanForMapJiakong.timeend }"
								placeholder="请输入：结束时间">
						</div>
					</div>
				</div>
				<div class="form-group col-md-6">
					<div class="col-md-2 div_label">架空量(kg)<span>*</span></div>
					<div class="col-md-10">
						<div class="has-warning">
							<input type="text" id="amount" class="form-control easyui-validatebox" missingMessage="请输入架空量" data-options="required:true" onkeyup="this.value=this.value.replace(/\D/g,'')"
							onblur="validInt(this)"
								name="BusinessPlanForMapJiakong.amount" value="${BusinessPlanForMapJiakong.amount }" placeholder="请输入：架空量(kg)" maxlength="11">
						</div>
					</div>
				</div>
			</div>
	...
	new myselect({
		...
		option_html : [ "wName" ],
		option_html_prefix : ",",
		selected_val:"${BusinessPlanForMapJiakong.wlId}"
	}, function() {
		//给change事件添加方法
		$("#selectCk").html("");
	...
	function ck() {
		new myselect({
			...
			option_html : [ "wName" ],
			option_html_prefix : ",",
			selected_val:"${BusinessPlanForMapJiakong.wId}"
		}, function() {
			//给change事件添加方法
