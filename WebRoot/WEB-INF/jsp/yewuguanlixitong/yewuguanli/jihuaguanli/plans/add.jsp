...
<body style="background-color:#d9edf7">
	...
	<div class=" col-md-12">
		<form id="form" name="form" method="post"
			action="${ctx}/businessManager/addPlan.shtml">
			<input type="hidden" name="token" value="${token}"> <input
				type="hidden" id="plans" name="BusinessPlaneFormMap.planType"
				value="${planType}"> <input type="hidden" id="amount"
				name="BusinessPlaneFormMap.totalAmount">
			<div class="form-group col-md-12">
					...
					<div class="col-md-10">
						<div class="has-warning">
							<input type="text" class="form-control easyui-validatebox" missingMessage="请输入计划编号" data-options="required:true"
								...
								placeholder="请输入 ：计划编号" maxlength="32">
						</div>
					</div>
				</div>
				...
				<div class="form-group col-md-6">
					...
					<div class="col-md-10">
						<div class="has-warning">
							...
							<input type="hidden" name="BusinessPlaneFormMap.wId" id="warehouse" >
						</div>
					</div>
				</div>
					...
					<div class="col-md-10">
						<div class="has-warning">
							...
							onblur="validInt(this)"
								placeholder="请输入 ：新增计划" maxlength="10">
						</div>
					</div>
				</div>
				...
				<div class="form-group col-md-6">
					...
					<div class="col-md-10">
						<div class="has-warning">
							...
							onblur="validInt(this)"
								placeholder="请输入 ：轮换计划" maxlength="10">
						</div>
					</div>
				</div>
					...
					<div class="col-md-10">
						<div class="has-warning">
							<select data-rel="chosen"
								data-placeholder="请选择业务类型" name="BusinessPlaneFormMap.type">
								<option value=""></option>
				...
				<div class="form-group col-md-6">
					...
					<div class="col-md-10">
						<div class="has-warning">
						  <input id="year"  type="text" class="form-control easyui-validatebox" missingMessage="请输入收获年度" data-options="required:true" name="BusinessPlaneFormMap.achieveYear"  placeholder="请输入 ：收获年度" maxlength="4">
						</div>
					</div>
				</div>
					...
					<div class="col-md-10">
						<div class="has-warning">
							<input id="start" type="text" class="form-control easyui-validatebox" missingMessage="请输入计划开始" data-options="required:true"
								name="BusinessPlaneFormMap.planedTimeStart"
					...
					<div class="col-md-10">
						<div class="has-warning">
							<input id="start1" type="text" class="form-control easyui-validatebox" missingMessage="请输入计划结束" data-options="required:true"
								name="BusinessPlaneFormMap.planedTimeEnd"
					...
					<div class="col-md-10">
						<div class="has-warning">
							<input type="text" class="form-control easyui-validatebox" missingMessage="请输入计划价格" data-options="required:true"
								name="BusinessPlaneFormMap.planedPrice" onkeyup="value=value.replace(/[^\-?\d.]/g,'')" onblur="validFloat(this)"
					...
					<div class="col-md-10">
						<div class="has-warning">
							<input type="text" class="form-control"
								name="BusinessPlaneFormMap.quailty" placeholder="请输入 ：入库质量" maxlength="250"/>
						</div>
					</div>
				</div>
					...
					<div class="col-md-11">
						<div class="has-warning">
							<textarea class="form-control" rows="4" cols="10"
								name="BusinessPlaneFormMap.department" placeholder="请输入 ：下达单位" maxlength="250"></textarea>
						</div>
					</div>
				</div>
				...
				<div class="form-group col-md-12">
					...
					<div class="col-md-11">
						<div class="has-warning">
							<textarea class="form-control" rows="4" cols="10"
								name="BusinessPlaneFormMap.comment" placeholder="请输入 ：备注" maxlength="250"></textarea>
						</div>
					</div>
				</div>
			</div>
