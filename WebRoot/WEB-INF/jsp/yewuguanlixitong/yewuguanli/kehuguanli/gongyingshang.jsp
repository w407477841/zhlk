...
<script type="text/javascript">
							...
							<div class=" col-md-12">
								<form id="searchForm" name="searchForm">
									<div class="form-group col-md-3">
										<input type="text" class="form-control" name="businessGuestCompanyFormMap.name"
											placeholder="单位名称">
									</div>
								</form>
							</div>
	...
	<!--/row-->
<script type="text/javascript"
	src="js/system/yewuguanlixiytong/yewuguanli/kehuguanli/gongyingshanglist.js"></script>
<script type="text/javascript">
