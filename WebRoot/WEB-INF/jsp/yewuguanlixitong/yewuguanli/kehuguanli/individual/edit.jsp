...
<body style="background-color:#d9edf7">
	...
	<div class=" col-md-12">
		<form id="form" name="form" method="post"
			action="${ctx}/businessManager/editIndividual.shtml">
			<input type="hidden" name="token" value="${token}">
			<input type="hidden" name="BusinessGuestIndividualFormMap.id" value="${BusinessGuestIndividualFormMap.id}">
			<div class="form-group col-md-12">
					...
					<div class="col-md-10">
						<div class="has-warning">
							<input type="text" class="form-control easyui-validatebox"
								...
								name="BusinessGuestIndividualFormMap.name" value="${BusinessGuestIndividualFormMap.name }"
					...
					<div class="col-md-10">
						<div class="has-warning">
							<input type="text" class="form-control easyui-validatebox"
								...
								name="BusinessGuestIndividualFormMap.concator" value="${BusinessGuestIndividualFormMap.concator }"
					...
					<div class="col-md-10">
						<div class="has-warning">
							<input type="text" class="form-control easyui-validatebox"
								...
								name="BusinessGuestIndividualFormMap.phone" value="${BusinessGuestIndividualFormMap.phone }"
					...
					<div class="col-md-10">
						<div class="has-warning">
							<input type="text" class="form-control"
								name="BusinessGuestIndividualFormMap.ranges" value="${BusinessGuestIndividualFormMap.ranges }"
				...
				<div class="form-group col-md-6">
					...
					<div class="col-md-10">
						<div class="has-warning">
							<input type="text" class="form-control"
								name="BusinessGuestIndividualFormMap.address" value="${BusinessGuestIndividualFormMap.address }"
				...
				<div class="form-group col-md-6">
					...
					<div class="col-md-10">
						<div class="has-warning">
							<input type="text" class="form-control"
								name="BusinessGuestIndividualFormMap.representer" value="${BusinessGuestIndividualFormMap.representer }"
