...
<body style="background-color:#d9edf7">
	...
	<div class=" col-md-12">
		<form id="form" name="form" method="post"
			action="${ctx}/businessManager/editAgreementForm.shtml">
			<input type="hidden" name="token" value="${token}"> 
			<input type="hidden" name="businessAgreementFormFormMap.id" value="${businessAgreementFormFormMap.id}"> 
					...
					<div class="col-md-10">
						<div class="has-warning">
							<input type="text" class="form-control easyui-validatebox" missingMessage="请输入模版名称" data-options="required:true"
								name="businessAgreementFormFormMap.fName" value="${businessAgreementFormFormMap.fName }"
