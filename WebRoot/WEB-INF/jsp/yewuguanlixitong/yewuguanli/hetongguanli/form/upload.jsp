...
<script type="text/javascript">
	...
	if(ex != ".jasper"){
		document.getElementById("drag").innerHTML="<span style='color:red;font-size:large'>请上传jasper文件!</span>";
		return false;
	}
	...
	var formData = new FormData();
		...
		formData.append("dataid",window.parent.selectRow.id);
		
		$.ajax({
			type : "POST",
			url : "${ctx}" + "/businessManager/uploadFormFile.shtml",
			data : formData,
			processData : false,
			contentType : false,
			xhr : function() {
