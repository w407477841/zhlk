						...
						<div class="row">
							<div class=" col-md-12">
								<form role="form" id="searchForm" name="searchForm">
									<div class="form-group col-md-3">
										<input type="text" name="businessAgreementFormFormMap.fName" class="form-control"
												placeholder="模版名称">
									</div>
								</form>
							</div>
							<div class=" col-md-12">
								...
								<a class="btn btn-primary" href="javascript:void(0)"
									...
									class="glyphicon glyphicon-open icon-white"></i> 上传模版
								</a>
								<a class="btn btn-primary" href="javascript:void(0)"
									id="download" style="text-shadow: black 5px 3px 3px;"> <i
									class="glyphicon glyphicon-save icon-white"></i> 下载模版
								</a>
							</div>
						</div>
					</div>
...
<script type="text/javascript"
	src="js/system/yewuguanlixiytong/yewuguanli/hetongguanli/form/list.js"></script>
<script type="text/javascript">
