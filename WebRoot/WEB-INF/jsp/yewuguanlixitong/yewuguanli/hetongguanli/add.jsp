...
<body style="background-color:#d9edf7">
	<div class=" col-md-6">
		<div class=" col-md-6">
			<h3 class="animated rubberBand">合同新增</h3>
		</div>
	</div>
	<div class=" col-md-6"></div>
	<div class=" col-md-12">
		<form id="form" name="form" method="post"
			action="${ctx}/businessManager/addAgreement.shtml">
			...
			<div class="form-group col-md-12">
					...
					<div class="col-md-10">
						<div class="has-warning">
							<input type="text" class="form-control"
								name="BusinessAgreementFormMap.soldOnes" placeholder="请输入：出售人"
								maxlength="32">
						</div>
					</div>
				</div>
				...
				<div class="form-group col-md-6">
					...
					<div class="col-md-10">
						<div class="has-warning">
							<input type="text" class="form-control"
								name="BusinessAgreementFormMap.buyOnes" placeholder="请输入：买售人"
								maxlength="32">
						</div>
					</div>
				</div>
				<div class="form-group col-md-6">
					...
					<div class="col-md-10">
						<div class="has-warning">
							<input type="text" class="form-control "
								name="BusinessAgreementFormMap.signTime" id="start"
				...
				<div class="form-group col-md-6">
					...
					<div class="col-md-10">
						<div class="has-warning">
							<input type="text" class="form-control"
								name="BusinessAgreementFormMap.signPlace" placeholder="请输入：签订地点"
								maxlength="255">
						</div>
					</div>
				</div>
				<div class="form-group col-md-6">
					...
					<div class="col-md-10">
						<div class="has-warning">
							<input type="text" class="form-control"
								name="BusinessAgreementFormMap.planedActiviteTime" id="start1"
								placeholder="请输入：履行时间">
						</div>
					</div>
				</div>
				<div class="form-group col-md-6">
					...
					<div class="col-md-10">
						<div class="has-warning">
							<input type="text" class="form-control"
								name="BusinessAgreementFormMap.realActiviteTime" id="start2"
								placeholder="请输入：实际履行时间">
						</div>
					</div>
				</div>
				<div class="form-group col-md-6">
					...
					<div class="col-md-10">
						<div class="has-warning">
							<input type="text" id="amount" class="form-control"
							    ...
							    onblur="validInt(this)" placeholder="请输入：数量(kg)"
								maxlength="10">
						</div>
					</div>
				</div>
				<div class="form-group col-md-6">
					...
					<div class="col-md-10">
						<div class="has-warning">
							<input type="text" class="form-control"
								name="BusinessAgreementFormMap.level" placeholder="请输入：质量等级"
								maxlength="32">
						</div>
					</div>
				</div>
					...
					<div class="col-md-10">
						<div class="has-warning">
							<input type="text" class="form-control"
								...
								onblur="validFloat(this)" placeholder="请输入：价格(元/kg)"
								maxlength="8">
						</div>
					</div>
				</div>
