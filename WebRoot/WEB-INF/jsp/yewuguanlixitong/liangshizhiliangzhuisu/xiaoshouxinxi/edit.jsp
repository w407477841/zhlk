...
<body style="background-color:#d9edf7">
	...
	<div class=" col-md-12">
		<form id="form" name="form" method="post"
			action="${ctx}/xiaoshouxinxi/editSellMsg.shtml">
			<input type="hidden" name="token" value="${token}"> 
			<input type="hidden" name="SellMsgFormMap.id" value="${SellMsgFormMap.id}"> 
			
			<input type="hidden" class="temp" name="" value="${SellMsgFormMap.location}">
			<input type="hidden" class="temp" name="" value="${SellMsgFormMap.houseid}">
			<input type="hidden" class="temp" name="" value="${SellMsgFormMap.breed}">
			<input type="hidden" class="temp" name="" value="${SellMsgFormMap.property}">
			...
			<div class="form-group col-md-12"
				...
				<div class="form-group col-md-6">
					...
					<div class="col-md-9">
						<div class="has-warning">
							<select id="selectBreed" data-rel="chosen" data-placeholder="粮食品种" name="SellMsgFormMap.breed" value="${SellMsgFormMap.breed }">
								<option value=""></option>
				...
				<div class="form-group col-md-6">
					...
					<div class="col-md-9">
						<div class="has-warning">
							<input type="text" class="form-control" name="SellMsgFormMap.weights" placeholder="收购重量" value="${SellMsgFormMap.weights }">
						</div>
					</div>
				</div>
				<div class="form-group col-md-6">
					...
					<div class="col-md-9">
						<div class="has-warning">
							<input type="text" class=" form-control "name="SellMsgFormMap.price"  placeholder="单价" value="${SellMsgFormMap.price }">
						</div>
					</div>
				</div>
					...
					<div class="col-md-9">
						<div class="has-warning">
							<input id="start" type="text" class=" inline laydate-icon  form-control " 
								name="SellMsgFormMap.dates"  value="${SellMsgFormMap.dates }" placeholder="收购日期">
						</div>
					</div>
				</div>
				...
				rs=JSON.parse(rs);
					if(rs.success){
						for ( var i = 0; i < rs.result.length; i++) {
							...
							if(rs.result[i].id=="${fn:split(SellMsgFormMap.houseid,',')[0]}"){
							ops.selected=true;
							}
							sel.add(ops);
						}
