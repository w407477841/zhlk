...
var rootPath="${pageContext.servletContext.contextPath}";
  ...
  <div class="row">
    ...
    <div class="box-header well" data-original-title="">
        <h2><i class="glyphicon glyphicon-list"></i> 出库质量信息</h2>
        <div class="box-icon">
...
<script type="text/javascript" src="js/system/yewuguanlixiytong/liangshizhiliangzhuisu/chukuzhiliangxinxilist.js"></script>
<script type="text/javascript">
