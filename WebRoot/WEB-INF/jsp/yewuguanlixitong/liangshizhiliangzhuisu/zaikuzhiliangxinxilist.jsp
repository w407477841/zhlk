...
display: block;
  ...
  <div class="row">
    ...
    <div class="box-header well" data-original-title="">
        <h2><i class="glyphicon glyphicon-list"></i> 在库质量信息</h2>
        <div class="box-icon">
...
<script type="text/javascript" src="js/system/yewuguanlixiytong/liangshizhiliangzhuisu/zaikuzhiliangxinxilist.js"></script>
<script type="text/javascript">
