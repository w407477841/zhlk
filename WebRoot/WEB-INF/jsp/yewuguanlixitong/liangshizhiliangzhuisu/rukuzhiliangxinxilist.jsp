...
display: block;
  ...
  <div class="row">
    ...
    <div class="box-header well" data-original-title="">
        <h2><i class="glyphicon glyphicon-list"></i> 出入库质量信息</h2>
        <div class="box-icon">
    ...
    <div class="alert alert-info "> 
     <form class="form-inline clear-float" role="form" id="searchForm"
			...
			<div style="float: left;">
				<input  type="text" class=" inline   form-control " style="height:30px"  name="id" value="" placeholder="流水单号">
			</div>
...
<script type="text/javascript" src="js/system/yewuguanlixiytong/liangshizhiliangzhuisu/rukuzhiliangxinxilist.js"></script>
<script type="text/javascript">
initLocation()
