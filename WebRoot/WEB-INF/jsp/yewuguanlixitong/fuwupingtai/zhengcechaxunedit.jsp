...
<body style="background-color:#d9edf7">
	<div class=" col-md-4">
		<div class=" col-md-6">
			<h3 class="animated rubberBand">文章发布</h3>
		</div>
	</div>
	<div class=" col-md-8"></div>
	<div class=" col-md-12">
		<form id="form" name="form" method="post"
			action="${ctx}/zhengcechaxun/edit.shtml">
			<input type="hidden" name="token" value="${token}"> <input
				type="hidden" name="zhengCeChaXunFormMap.id"
				value="${zhengCeChaXunFormMap.id }"> <input type="hidden"
				name="zhengCeChaXunFormMap.version"
				value="${zhengCeChaXunFormMap.version }">
				...
				<div class="col-md-11">
					<div class="has-warning">
						<input type="text" class="form-control easyui-validatebox"
							...
							name="zhengCeChaXunFormMap.pqTitle"
							value="${zhengCeChaXunFormMap.pqTitle }" placeholder="请输入 ：文章标题"
							maxlength="128">
					</div>
				</div>
			</div>
   ...
   ${zhengCeChaXunFormMap.pqContent}
	...
	<script type="text/javascript">
		...
		var sel = new myselect({
			...
			option_html : [ "itName" ],
			option_html_prefix : ",",
			selected_val : ${zhengCeChaXunFormMap.pqType}
