...
<script type="text/javascript">
					...
					<div class="row">
						...
						<form id="searchForm"
							...
							<input type="text" class="form-control"
								name="yuYueJiaoLiangFormMap.agBill" value="" placeholder="预约号">
								</div>
								<div class="form-group col-md-3">
							<input type="text" class="form-control"
								name="yuYueJiaoLiangFormMap.agIDCard" value=""
								placeholder="身份证号">
								</div>
						</form>
						</div>
	...
	<!--/row-->
<script type="text/javascript"
	src="js/system/yewuguanlixiytong/fuwupingtai/yuyuejiaolianglist.js"></script>
<script type="text/javascript">
