...
<body style="background-color:#d9edf7">
	...
	<div class=" col-md-12">
		<form id="form" name="form" method="post"
			action="${ctx}/yuyuejiaoliang/add.shtml">
				...
				<div class="col-md-10">
					<div class="has-warning">
						<input type="text" class="form-control"
							name="yuYueJiaoLiangFormMap.agName" placeholder="请输入 ：姓名"
							maxlength="32">
					</div>
				</div>
			</div>
				...
				<div class="col-md-10">
					<div class="has-warning">
						<input type="text" class="form-control easyui-validatebox"
							...
							name="yuYueJiaoLiangFormMap.agIDCard" placeholder="请输入 ：身份证号"
							maxlength="18">
					</div>
				</div>
			</div>
				...
				<div class="col-md-10">
					<div class="has-warning">
						<input type="text" class="form-control"
							...
							placeholder="请输入 ：数量(kg)" maxlength="11">
					</div>
				</div>
			</div>
			<div class="form-group col-md-6">
			...
			<div class="form-group col-md-6">
				...
				<div class="col-md-10">
					<div class="has-warning">
						<input type="text" class="form-control"
							name="yuYueJiaoLiangFormMap.agAddress" placeholder="请输入 ：地址"
							maxlength="128">
					</div>
				</div>
			</div>
