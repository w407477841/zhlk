...
<script type="text/javascript">
					...
					<div class="row">
						...
						<form id="searchForm"
							...
							<input type="text" class="form-control"
								name="xinXiFaBuFormMap.irTitle" value="" placeholder="信息标题">
								</div>
						</form>
						</div>
						<div class=" col-md-12">
						...
						</a> <a class="btn btn-info" href="javascript:void(0)" id="upFun"
							style="text-shadow: black 5px 3px 3px;"> <i
							class="glyphicon glyphicon-arrow-up icon-white"></i> 置顶
						</a> <a class="btn btn-info" href="javascript:void(0)" id="downFun"
							style="text-shadow: black 5px 3px 3px;"> <i
							class="glyphicon glyphicon-arrow-down icon-white"></i> 取消置顶
	...
	<!--/row-->
<script type="text/javascript"
	src="js/system/yewuguanlixiytong/fuwupingtai/xinxifabulist.js"></script>
<script type="text/javascript">
