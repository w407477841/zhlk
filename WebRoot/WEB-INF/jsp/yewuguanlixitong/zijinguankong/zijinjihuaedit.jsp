...
<body style="background-color:#d9edf7">
	...
	<div class=" col-md-12">
		<form id="form" name="form" method="post"
			action="${ctx}/zijinjihua/edit.shtml">
			<input type="hidden" name="ziJinJiHuaFormMap.id"
				value="${ziJinJiHuaFormMap.id }"> <input type="hidden"
				name="ziJinJiHuaFormMap.version"
				value="${ziJinJiHuaFormMap.version }"> <input type="hidden"
				...
				<div class="col-md-10">
					<div class="has-warning">
						<input type="text" class="form-control easyui-validatebox"
							...
							value="${ziJinJiHuaFormMap.bpGrandPerson }" maxlength="32">
					</div>
				</div>
			</div>
			<div class="form-group col-md-6">
				...
				<div class="col-md-10">
					<div class="has-warning">
						<input type="text" class="form-control easyui-validatebox"
							...
							value="${ziJinJiHuaFormMap.bpPayee }" maxlength="32">
					</div>
				</div>
			</div>
			<div class="form-group col-md-6">
				...
				<div class="col-md-10">
					<div class="has-warning">
						<input type="text" class="form-control easyui-validatebox"
							...
							maxlength="11" onkeyup="chengeUpper(this)"
							onblur="validInt(this)"
							value="${ziJinJiHuaFormMap.bpLowerMoney }"
				...
				<div class="col-md-10">
					<div class="has-warning">
						<input type="text" class="form-control" id="upmoney"
							placeholder="请输入 ：拨款金额(大写)" disabled="disabled"
							value="${ziJinJiHuaFormMap.bpUpperMoney }"> <input
							type="hidden" id="upmoneyt" name="ziJinJiHuaFormMap.bpUpperMoney"
							value="${ziJinJiHuaFormMap.bpUpperMoney }">
					</div>
				</div>
			</div>
			<div class="form-group col-md-6">
				...
				<div class="col-md-10">
					<div class="has-warning">
						<input type="text" class="form-control easyui-validatebox"
							...
							onblur="validInt(this)" value="${ziJinJiHuaFormMap.bpAccount }"
							name="ziJinJiHuaFormMap.bpAccount" placeholder="请输入 ：收款帐号"
							maxlength="32">
					</div>
				</div>
			</div>
			<div class="form-group col-md-6">
				...
				<div class="col-md-10">
					<div class="has-warning">
						<input type="text" class="form-control easyui-validatebox"
							missingMessage="请输入拨款时间" data-options="required:true"
							id="dateformat" value="${ziJinJiHuaFormMap.bpGrandDate }"
							placeholder="请输入 ：拨款时间 " name="ziJinJiHuaFormMap.bpGrandDate">
					</div>
				</div>
			</div>
				...
				<div class="col-md-11">
					<div class="has-warning">
						<textarea rows="4" cols="20" class="form-control easyui-validatebox" missingMessage="请输入用途"
							...
							maxlength="128">${ziJinJiHuaFormMap.bpUse }</textarea>
					</div>
				</div>
			</div>
