...
var rootPath="${pageContext.servletContext.contextPath}";
  ...
  <div class="row">
    ...
    <div class="box-header well" data-original-title="">
        <h2><i class="glyphicon glyphicon-list"></i> 入库报表</h2>
        <div class="box-icon">
...
<script type="text/javascript" src="js/system/yewuguanlixiytong/baobiaochaxun/cangkubaobiao/rukubaobiaolist.js"></script>
<script type="text/javascript">
