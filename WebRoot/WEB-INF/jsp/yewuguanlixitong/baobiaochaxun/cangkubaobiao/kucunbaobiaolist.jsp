					...
					<div class="row">
						<div class=" col-md-12">
							<form id="searchForm" name="searchForm">
							  <div  class="form-group col-md-6">
								<select id="selectmingcheng" name="storageInfoFormMap.selectmingcheng" data-rel="chosen" 
							   ...
							   <div  class="form-group col-md-6">
								<select id="selectLocation" data-rel="chosen" onchange="changeValues()"
											data-placeholder="粮库地点" multiple="multiple"
											style="width:100%">
											<option value=""></option>
								</select>
								<input type="hidden" name="storageInfoFormMap.locationList" id="locationId">
								</div>
								<div class="form-group col-md-6">
									<select id="selectProperty" data-rel="chosen" onchange="changePropertyValues()"
											data-placeholder="粮食性质" multiple="multiple"
											style="width:100%">
											<option value=""></option>
								    </select>
								    <input type="hidden" name="storageInfoFormMap.propertyList" id="propertyList">
								</div>
								<div class="form-group col-md-6">
									<select id="selectVariety" data-rel="chosen" onchange="changeVarietyValues()"
											data-placeholder="粮食品种" multiple="multiple"
											style="width:100%">
											<option value=""></option>
								    </select>
								    <input type="hidden" name="storageInfoFormMap.varietyList" id="varietyList">
								</div>
								<div class="form-group col-md-6">
									<input type="text" id="writeUnit" class="form-control"
										name="writeUnit" placeholder="填报单位" maxlength="64" value="${writeUnit}">
								</div>
								<!-- 
								<div class="form-group col-md-6">
									<input type="text" id="writeDate" class="form-control"
										name="writeDate" value="" placeholder="填报时间" maxlength="32">
								</div>
								 -->
							</form>
						</div>
						<div class=" col-md-12">
							<a class="btn btn-primary" href="javascript:void(0)" id="search"
								...
								href="javascript:void(0)" id="export"
								style="text-shadow: black 5px 3px 3px;"> <i
...
<!--/row-->
<script type="text/javascript"
	src="js/system/yewuguanlixiytong/baobiaochaxun/cangkubaobiao/kucunbaobiaolist.js"></script>
<script type="text/javascript">
...
(function() {
	...
	new myselect({
		...
		url : rootPath + "/warehouseLocationInterface/findAllMingCheng.shtml",
...
function findWarehouse(){
	...
	new myselect({
		...
		url : rootPath + "/warehouseLocationInterface/findAllByXinYongDaiMa.shtml",
...
function changePropertyValues(){
	...
	if(arr.length > 6){
		layer.alert("报表最多显示五个粮食性质！",{icon:7});
	}
...
function changeVarietyValues(){
	...
	var arr = weights.split(",");
	if(arr.length > 4){
		layer.alert("报表最多显示三个粮食性质！",{icon:7});
	}
