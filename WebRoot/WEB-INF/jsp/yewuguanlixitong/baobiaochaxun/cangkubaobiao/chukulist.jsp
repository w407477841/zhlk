		...
		<div class="box col-md-12">
			<div class="box-inner">
				<div class="box-header well" data-original-title="">
					<h2>
						<i class="glyphicon glyphicon-list"></i> 出库报表
					</h2>
					<div class="box-icon">
				...
				<div class="box-content" id="page">
					<div class="alert alert-info">
						<form class="form-inline" role="form" id="searchForm"
							name="searchForm">
							<input type="text" name="userLoginLogFormMap.accountName"
								value="" placeholder="账户名称">
						</form>
						...
						</a> <a class="btn btn-primary" href="javascript:void(0)" id="export"
							style="text-shadow: black 5px 3px 3px;"> <i
							class="glyphicon glyphicon-export icon-white"></i> 数据导出
						</a>
					</div>
					<table id="" style="width:99%;height:600px">
					</table>
	...
	<div class="row">
		<div class="box col-md-12 tour">
			<div class="box-inner">
				<div class="box-header well" data-original-title="">
					<h2>
						<i class="glyphicon glyphicon-globe"></i> 提示：
					</h2>
...
<script type="text/javascript"
	src="js/system/yewuguanlixiytong/baobiaochaxun/cangkubaobiao/chukubaobiaolist.js"></script>
<script type="text/javascript">
