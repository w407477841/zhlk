...
<script type="text/javascript" src="js/system/yewuguanlixiytong/baobiaochaxun/cangkubaobiao/fendianlist.js"></script>
<script type="text/javascript">
...
$("#location,#pack,#property,#breed,#property,#storageStation").chosen({no_results_text : "未找到此选项!"});
