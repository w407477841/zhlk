...
var rootPath="${pageContext.servletContext.contextPath}";
  ...
  <div class="row">
    ...
    <div class="box-header well" data-original-title="">
        <h2><i class="glyphicon glyphicon-list"></i> 入库质检记录</h2>
        <div class="box-icon">
...
<script type="text/javascript" src="js/system/yewuguanlixiytong/baobiaochaxun/zhiliangbaobiao/rukuzhijianjilulist.js"></script>
<script type="text/javascript">
