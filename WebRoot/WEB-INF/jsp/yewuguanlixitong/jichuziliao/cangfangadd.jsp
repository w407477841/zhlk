...
<body style="background-color:#d9edf7">
	...
	<div class=" col-md-12">
		<form id="form" name="form" method="post"
			action="${ctx}/warehouse/add.shtml">
				...
				<div class="col-md-10">
					<div class="has-warning">
						<input type="text" class="form-control easyui-validatebox"
							data-options="required:true" id="warehouseId"
							onkeyup="this.value=this.value.replace(/\D/g,'')"
							onblur="isExist()" name="warehouseFormMap.id"
				...
				<div class="col-md-10">
					<div class="has-warning">
						<input type="text" class="form-control easyui-validatebox"
							...
							placeholder="请输入 ：仓库名称" maxlength="32">
					</div>
				</div>
			</div>
	...
	<script type="text/javascript">
		...
		function isExist() {
			...
			$.ajax({
				type : 'post',
				dataType : 'json',
				url : '${ctx}/warehouse/isExist.shtml',
				data : {
					id : id
				},
				success : function(data) {
