							...
							<form id="searchForm" name="searchForm">
								   <div class="form-group col-md-3">
									<select id="selectLocation" data-rel="chosen"
											...
											name="cangFangXinXiFormMap.waLocation" style="width:100%">
											<option value=""></option>
										</select>
								</div>
								<div class="form-group col-md-3">
										<select class="form-control" id="warehouse"
											name="cangFangXinXiFormMap.wNo" data-rel="chosen"
											data-placeholder="仓号">
										</select>
								</div>
							</form>
...
<script type="text/javascript"
	src="js/system/yewuguanlixiytong/jichuziliao/cangfangxinxilist.js"></script>
<script type="text/javascript">
