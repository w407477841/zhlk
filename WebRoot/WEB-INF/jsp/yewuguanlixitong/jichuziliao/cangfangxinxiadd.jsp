...
<body style="background-color:#d9edf7">
	...
	<div class=" col-md-12">
		<form id="form" name="form" method="post"
			action="${ctx}/cangfangxinxi/add.shtml">
				...
				<div class="col-md-10">
					<div class="has-warning">
						<input type="text" class="form-control easyui-validatebox"
							...
							onblur="validInt(this)" name="cangFangXinXiFormMap.waWindow"
							placeholder="请输入 ：窗户数量(扇)" maxlength="3">
					</div>
				</div>
			</div>
			<div class="form-group col-md-6">
				...
				<div class="col-md-10">
					<div class="has-warning">
						<input type="text" class="form-control easyui-validatebox"
							data-options="required:true"
							onkeyup="this.value=this.value.replace(/\D/g,'')"
							onblur="validInt(this)" name="cangFangXinXiFormMap.waDoorNumber"
			...
			<div class="form-group col-md-6">
				...
				<div class="col-md-10">
					<div class="has-warning">
						<input type="text" class="form-control"
							name="cangFangXinXiFormMap.waStructure" placeholder="请输入 ：结构"
							maxlength="32">
					</div>
				</div>
			</div>
				...
				<div class="col-md-10">
					<div class="has-warning">
						<input type="text" class="form-control easyui-validatebox"
							...
							placeholder="请输入 ：设计容量(kg)" maxlength="11">
					</div>
				</div>
			</div>
			<div class="form-group col-md-6">
				...
				<div class="col-md-10">
					<div class="has-warning">
						<input type="text" class="form-control easyui-validatebox"
							data-options="required:true"
							onkeyup="value=value.replace(/[^\-?\d.]/g,'')"
							onblur="validFloat(this)" name="cangFangXinXiFormMap.waInnerLong"
							placeholder="请输入 ：内墙长(米)" maxlength="6">
					</div>
				</div>
			</div>
			<div class="form-group col-md-6">
			...
			<div class="form-group col-md-6">
				...
				<div class="col-md-10">
					<div class="has-warning">
						<input type="text" class="form-control"
							name="cangFangXinXiFormMap.waSequence" placeholder="请输入 ：排序号"
							maxlength="32">
					</div>
				</div>
			</div>
