				...
				<div class="alert alert-info">
					<div class="row">
							...
							<form id="searchForm" name="searchForm">
								<div class="form-group col-md-3">
									<select id="selectLocation" data-rel="chosen"
											...
											name="warehouseLocationFormMap.wlNo" style="width:100%">
											<option value=""></option>
										</select>
								</div>
							</form>
						...
						<div class=" col-md-12">
							...
							</a> <a class="btn btn-primary" href="javascript:void(0)" id="upload1"
								style="text-shadow: black 5px 3px 3px;"> <i
								class="glyphicon glyphicon-open icon-white"></i> 上传门户图
							</a> <a class="btn btn-primary" href="javascript:void(0)" id="upload2"
								style="text-shadow: black 5px 3px 3px;"> <i
								class="glyphicon glyphicon-open icon-white"></i> 上传平面图
							</a>
						</div>
					</div>
				</div>
...
<!--/row-->
<script type="text/javascript"
	src="js/system/yewuguanlixiytong/jichuziliao/liangkulist.js"></script>
<script type="text/javascript">
$("#showImg").hide();
