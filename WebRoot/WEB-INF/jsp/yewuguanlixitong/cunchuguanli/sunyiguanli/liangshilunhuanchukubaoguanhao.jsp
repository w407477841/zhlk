					...
					<div class="row">
							...
							<form id="searchForm" name="searchForm">
								<div class="form-group col-md-3">
									<select id="selectLocation" data-rel="chosen"
										...
										name="lunHuanChuKuBaoGuanHaoFormMap.wLocation"
										style="width:100%">
										<option value=""></option>
									</select>
								</div>
								<div class="form-group col-md-3">
									<select class="form-control" id="warehouse"
										name="lunHuanChuKuBaoGuanHaoFormMap.waNo" data-rel="chosen"
										data-placeholder="仓号">
									</select>
								</div>
							</form>
						...
						<div class=" col-md-12">
							<a class="btn btn-primary" href="javascript:void(0)" id="search"
								...
								class="glyphicon glyphicon-remove icon-white"></i> 修改
...
<!--/row-->
<script type="text/javascript"
	src="js/system/yewuguanlixiytong/cunchuguanli/sunyiguanli/liangshilunhuanchukubaoguanhao.js"></script>
<script type="text/javascript">
