...
var rootPath="${pageContext.servletContext.contextPath}";
  ...
  <div class="row">
    ...
    <div class="box-header well" data-original-title="">
        <h2><i class="glyphicon glyphicon-list"></i> 收购凭证</h2>
...
<script type="text/javascript" src="js/system/yewuguanlixiytong/cunchuguanli/churukuguanli/danjuguanli/shougoupingzheng.js"></script>
<script type="text/javascript">
