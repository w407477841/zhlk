...
<div class=" col-md-12"> 
<form id="form" name="form" method="post" action="${ctx}/shoukuantongzhidan/add.shtml">
<input type="hidden" name="token" value="${token }">
   ...
   <div class="col-md-10">
    <div class="has-warning">
    <input type="text" class="form-control" name="shouKuanTongZhiDanFormMap.cnCustomName" placeholder="请输入 ：客户名称" maxlength="32">
   </div> 
   </div>
   </div>
    <div class="form-group col-md-6">
   ...
   <div class="col-md-10">
    <div class="has-warning">
    <input type="text" class="form-control" onkeyup="value=value.replace(/[^\-?\d.]/g,'')" onblur="validFloat(this)" name="shouKuanTongZhiDanFormMap.cnPayment" placeholder="请输入 ：货款(元)" maxlength="9">
   </div> 
   </div>
   </div>
   ...
   <div class="col-md-10">
    <div class="has-warning">
   <input type="text" class="form-control" id="dateformat" placeholder="请输入 ：到账日期" name="shouKuanTongZhiDanFormMap.cnMoneyDate">
  </div> 
   </div>
   </div>   
   ...
   <div class="col-md-10">
    <div class="has-warning">
    <input type="text" class="form-control" onkeyup="this.value=this.value.replace(/\D/g,'')" onblur="validInt(this)" placeholder="请输入 ：收获年度" name="shouKuanTongZhiDanFormMap.cnYear" maxlength="4">
    </div> 
   </div>
   </div> 
