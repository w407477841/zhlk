...
var rootPath="${pageContext.servletContext.contextPath}";
  ...
  <div class="row">
    ...
    <div class="box-header well" data-original-title="">
        <h2><i class="glyphicon glyphicon-list"></i> 收款通知单</h2>
    ...
    <div class="alert alert-info"> 
     <form class="form-inline" role="form" id="searchForm"
			name="searchForm">
			<input type="text" class="form-control" name="shouKuanTongZhiDanFormMap.cnCustomName" value="" placeholder="客户名称">
    </form>
    <a class="btn btn-primary" href="javascript:void(0)" id="search" style="text-shadow: black 5px 3px 3px;">
                <i class="glyphicon glyphicon-search icon-white" ></i>
               		查询
            	</a> 
      	       <a class="btn btn-info" href="javascript:void(0)" id="addFun" style="text-shadow: black 5px 3px 3px;">
                <i class="glyphicon glyphicon-plus icon-white" ></i>
               		新增
            	</a>
            	<a class="btn btn-warning" href="javascript:void(0)" id="editFun" style="text-shadow: black 5px 3px 3px;">
                <i class="glyphicon glyphicon-edit icon-white" ></i>
               		编辑
            	</a>
            	<a class="btn btn-danger" href="javascript:void(0)" id="deleFun" style="text-shadow: black 5px 3px 3px;">
                <i class="glyphicon glyphicon-remove icon-white" ></i>
               		删除
            	</a>    
            	<a class="btn btn-info" href="javascript:void(0)" id="lookFun" style="text-shadow: black 5px 3px 3px;">
...
<script type="text/javascript" src="js/system/yewuguanlixiytong/cunchuguanli/churukuguanli/danjuguanli/shoukuantongzhidan.js"></script>
<script type="text/javascript">
