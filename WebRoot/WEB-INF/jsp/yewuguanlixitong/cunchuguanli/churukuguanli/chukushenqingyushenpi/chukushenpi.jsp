			...
			<div class="box-inner">
				...
				<div class="box-content" id="page">
					...
					<div class="row">
						...
						</a> <a class="btn btn-info" href="javascript:void(0)" id="approveFun"
							style="text-shadow: black 5px 3px 3px;"> <i
...
<script type="text/javascript"
	src="js/system/yewuguanlixiytong/cunchuguanli/churukuguanli/chukushenqingyushenpi/chukushenpi.js"></script>
<script type="text/javascript">
