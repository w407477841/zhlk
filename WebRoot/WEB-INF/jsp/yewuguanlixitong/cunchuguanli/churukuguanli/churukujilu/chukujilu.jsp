...
var rootPath="${pageContext.servletContext.contextPath}";
  ...
  <div class="row">
    ...
    <div class="box-header well" data-original-title="">
        <h2><i class="glyphicon glyphicon-list"></i> 出库记录</h2>
...
<script type="text/javascript" src="js/system/yewuguanlixiytong/cunchuguanli/churukuguanli/churukujilu/chukujilu.js"></script>
<script type="text/javascript">
