...
var rootPath="${pageContext.servletContext.contextPath}";
  ...
  <div class="row">
    ...
    <div class="box-header well" data-original-title="">
        <h2><i class="glyphicon glyphicon-list"></i> 粮食收付日记账</h2>
    ...
    <div class="alert alert-info"> 
     <form class="form-inline" role="form" id="searchForm"
			name="searchForm">
			<input type="text" name="userLoginLogFormMap.accountName" value="" placeholder="开始时间">
			<input type="text" name="userLoginLogFormMap.accountName" value="" placeholder="结束时间">
    </form>
            ...
            <table id="magazineGrid"  style="width:99%">
