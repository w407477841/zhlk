							...
							<form id="searchForm" name="searchForm">
								<div class="form-group col-md-3">
									<select id="selectLocation" data-rel="chosen"
											...
											name="chuKuFangAnFormMap.wlNo" style="width:100%">
											<option value=""></option>
										</select>
								</div>
								<div class="form-group col-md-3">
										<select class="form-control" id="warehouse"
											name="chuKuFangAnFormMap.wNo" data-rel="chosen"
											data-placeholder="仓号">
										</select>
								</div>
							</form>
...
<script type="text/javascript"
	src="js/system/yewuguanlixiytong/cunchuguanli/churukuguanli/churukufangan/chukufangan.js"></script>
<script type="text/javascript">
