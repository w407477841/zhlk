...
<body style="background-color:#d9edf7">
	...
	<div class=" col-md-12">
		<form id="form" name="form" method="post"
			action="${ctx}/chukufangan/add.shtml">
				...
				<div class="col-md-10">
					<div class="has-warning">
						<select class="form-control" id="warehouseName"
							name="chuKuFangAnFormMap.gspWId" data-rel="chosen"
			...
			<div class="form-group col-md-6">
				...
				<div class="col-md-10">
					<div class="has-warning">
					   <input type="text" id="selectvarietyText" class="form-control easyui-validatebox"
							missingMessage="请选择仓号" data-options="required:true" readonly="readonly">
					   <input type="hidden" id="selectvariety" name="chuKuFangAnFormMap.gspVariety">
			...
			<div class="form-group col-md-6">
				...
				<div class="col-md-10">
					<div class="has-warning">
					<input type="text" id="selectcategoryText" class="form-control easyui-validatebox"
							missingMessage="请选择仓号" data-options="required:true" readonly="readonly">
				    <input type="hidden" id="selectcategory" name="chuKuFangAnFormMap.gspCategory">
					</div>
				</div>
			</div>
				...
				<div class="col-md-10">
					<div class="has-warning">
						<input type="text" class="form-control"
							name="chuKuFangAnFormMap.gspFileName" placeholder="请输入 ：文件名称"
							maxlength="64">
					</div>
				</div>
			</div>
			<div class="form-group col-md-6">
				<div class="col-md-2 div_label">重量(kg)<span>*</span></div>
				<div class="col-md-10">
					<div class="has-warning">
						<input type="text" class="form-control easyui-validatebox"
							missingMessage="请输入重量" data-options="required:true" id="currentWeight"
