							...
							<form id="searchForm" name="searchForm">
								<div class="form-group col-md-3">
									<select id="selectLocation" data-rel="chosen"
											...
											name="FoodStorageSteamFormMap.wlNo" style="width:100%">
											<option value=""></option>
										</select>
								</div>
								<div class="form-group col-md-3">
										<select class="form-control" id="warehouse"
											name="FoodStorageSteamFormMap.wNo" data-rel="chosen"
											data-placeholder="仓号">
										</select>
								</div>
								<div class="form-group col-md-3">
									<select id="selectVariety" data-rel="chosen"
										name="FoodStorageSteamFormMap.breed" data-placeholder="粮食品种"
										style="width:100%">
										<option value=""></option>
									</select>
								</div>
								<div class="form-group col-md-3">
									<select id="selectType" data-rel="chosen"
										name="FoodStorageSteamFormMap.type" data-placeholder="熏蒸类型"
										style="width:100%">
										<option value=""></option>
...
<script type="text/javascript"
	src="js/system/yewuguanlixiytong/cunchuguanli/chuliangguanli/chuliangzuoyeguanli/zuoyejilu/stream.js"></script>
<script type="text/javascript">
