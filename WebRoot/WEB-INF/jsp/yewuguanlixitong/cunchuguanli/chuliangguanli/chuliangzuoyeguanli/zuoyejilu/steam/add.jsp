	...
	<div class=" col-md-12">
		<form id="form" name="form" method="post"
			...
			<input type="hidden" name="token" value="${token}"> <input
				type="hidden" name="FoodStorageSteamFormMap.type" value="0">
					...
					<div class="col-md-9">
						<div class="has-warning">
							<select id="selectLocation" data-rel="chosen"
								name="FoodStorageSteamFormMap.location" data-placeholder="请选择粮库地点">
								<option value=""></option>
							</select>
						</div>
					</div>
               ...
               <div class="form-group col-md-6">
					...
					<div class="col-md-9">
						<div class="has-warning">
							<input type="text" id="currentWeight" class="form-control" readonly="readonly"
								name="FoodStorageSteamFormMap.amount" placeholder="请输入：数量(kg)">
						</div>
					</div>
				</div>
				...
				<div class="form-group col-md-6">
					...
					<div class="col-md-9">
						<div class="has-warning">
							<input type="text" class="form-control"
								name="FoodStorageSteamFormMap.medicineType" placeholder="请输入：剂型与纯度" maxlength="64">
						</div>
					</div>
				</div>
				...
				<div class="form-group col-md-6">
					...
					<div class="col-md-9">
						<div class="has-warning">
							<input type="text" class="form-control"
								name="FoodStorageSteamFormMap.temperature" placeholder="请输入：气温（℃）" maxlength="10">
						</div>
					</div>
				</div>
				<div class="form-group col-md-6">
			...
			<div class="form-group col-md-12"
				...
				<div class="form-group col-md-4">
					...
					<div class="col-md-9">
						<div class="has-warning">
							<input type="text" class="form-control"
								name="FoodStorageSteamFormMap.foodTotle" placeholder="请输入：堆粮（m3）" maxlength="10">
						</div>
					</div>
				</div>
				<div class="form-group col-md-4">
					...
					<div class="col-md-9">
						<div class="has-warning">
							<input type="text" class="form-control"
								name="FoodStorageSteamFormMap.spaceTotle" placeholder="请输入：空间（m3）" maxlength="10">
						</div>
					</div>
				</div>
				<div class="form-group col-md-4">
					...
					<div class="col-md-9">
						<div class="has-warning">
							<input type="text" class="form-control"
								name="FoodStorageSteamFormMap.sumTotal" placeholder="请输入：合计（m3）" maxlength="10">
						</div>
					</div>
				</div>
					...
					<div class="col-md-9">
						<div class="has-warning">
							<input type="text" class="form-control"
								...
								placeholder="请输入：堆粮用药量（Kg）" maxlength="10">
						</div>
					</div>
				</div>
				<div class="form-group col-md-4">
					...
					<div class="col-md-9">
						<div class="has-warning">
							<input type="text" class="form-control"
								...
								placeholder="请输入：空间用药量（Kg）" maxlength="10">
						</div>
					</div>
				</div>
				<div class="form-group col-md-4">
					...
					<div class="col-md-9">
						<div class="has-warning">
							<input type="text" class="form-control"
								...
								placeholder="请输入：合计用药量（Kg）" maxlength="10">
						</div>
					</div>
				</div>
			</div>
			<div class="form-group col-md-12"
				...
				<div class="form-group col-md-6">
					...
					<div class="col-md-9">
						<div class="has-warning">
							<input type="text" class="form-control"
								name="FoodStorageSteamFormMap.killingPercent" placeholder="请输入：杀虫率" maxlength="10">
						</div>
					</div>
				</div>
				<div class="form-group col-md-6">
					...
					<div class="col-md-9">
						<div class="has-warning">
							<input type="text" class="form-control"
								name="FoodStorageSteamFormMap.buildDays" placeholder="请输入：培养天数(天)" maxlength="10">
						</div>
					</div>
				</div>
			</div>
