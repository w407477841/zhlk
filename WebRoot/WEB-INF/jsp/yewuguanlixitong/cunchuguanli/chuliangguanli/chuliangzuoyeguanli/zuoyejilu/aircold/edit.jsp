...
<body style="background-color:#d9edf7">
	<div class=" col-md-12">
		<form id="form" name="form" method="post"
			action="${ctx}/foodStorageManager/editAirCold.shtml">
			<input type="hidden" name="token" value="${token}"> <input
				type="hidden" name="FoodStorageAirColdFormMap.id"
				value="${FoodStorageAirColdFormMap.id}"> <input
				type="hidden" id="totalTime"
				name="FoodStorageAirColdFormMap.timeTotal"
				value="${FoodStorageAirColdFormMap.timeTotal}"> <input
				type="hidden" class="temp" name=""
				value="${FoodStorageAirColdFormMap.breed}"> <input
				type="hidden" class="temp" name=""
				value="${FoodStorageAirColdFormMap.location}"> <input
				type="hidden" class="temp" name=""
				value="${FoodStorageAirColdFormMap.houseid}">
			...
			<div class="form-group col-md-12"
					...
					<div class="col-md-9">
						<div class="has-warning">
							<select id="selectCk" data-rel="chosen"
								name="FoodStorageAirColdFormMap.houseid" data-placeholder="请选择仓号">
								<option value=""></option>
							</select>
						</div>
					</div>
				...
				<div class="form-group col-md-6">
					...
					<div class="col-md-9">
						<div class="has-warning">
						<input id="varietyName" type="text" readonly="readonly" class="form-control" value="${FoodStorageAirColdFormMap.text }">
						<input id="varietyId" type="hidden" name="FoodStorageAirColdFormMap.breed" value="${FoodStorageAirColdFormMap.breed }">
						</div>
					</div>
				</div>
					...
					<div class="col-md-9">
						<div class="has-warning">
							<input type="text" id="currentWeight" class="form-control"
								name="FoodStorageAirColdFormMap.amount" readonly="readonly"
								value="${FoodStorageAirColdFormMap.amount }"
								placeholder="请输入：数量(公斤)">
						</div>
					</div>
				</div>
					...
					<div class="col-md-9">
						<div class="has-warning">
							<input type="text" class=" form-control "
								...
								value="${ FoodStorageAirColdFormMap.devicetype}"
					...
					<div class="col-md-9">
						<div class="has-warning">
							<input type="text" class=" form-control "
								...
								value="${FoodStorageAirColdFormMap.deviceAmount }"
					...
					<div class="col-md-9">
						<div class="has-warning">
							<input type="text" class="form-control"
								...
								value="${FoodStorageAirColdFormMap.height }"
				...
				<div class="form-group col-md-6">
					...
					<div class="col-md-9">
						<div class="has-warning">
							<input type="text" class="form-control"
								name="FoodStorageAirColdFormMap.thick"
								value="${FoodStorageAirColdFormMap.thick }"
								placeholder="请输入：粮层厚度(M)">
						</div>
					</div>
				</div>
				<div class="form-group col-md-6">
					...
					<div class="col-md-9">
						<div class="has-warning">
							<input type="text" class="form-control"
								...
								value="${ FoodStorageAirColdFormMap.devicePower}"
					...
					<div class="col-md-9">
						<div class="has-warning">
							<input type="text" class="form-control"
								...
								value="${FoodStorageAirColdFormMap.totlePower }"
					...
					<div class="col-md-9">
						<div class="has-warning">
							<input id="start" type="text"
								class="form-control"
								name="FoodStorageAirColdFormMap.times"
								value="${FoodStorageAirColdFormMap.times }" placeholder="请输入：开始时间">
						</div>
					</div>
				</div>
					...
					<div class="col-md-9">
						<div class="has-warning">
							<input id="start1" type="text"
								class="form-control"
								name="FoodStorageAirColdFormMap.timee"
								value="${FoodStorageAirColdFormMap.timee }" placeholder="请输入：结束时间">
						</div>
					</div>
				</div>
			</div>
			...
			<div class="form-group col-md-12"
				...
				<div class=" col-md-12">
					<div class=" col-md-2">
						<h3 class="animated rubberBand">冷却参数</h3>
					</div>
					<div class=" col-md-10">
							...
							<div class="col-md-12">
								<div class="has-warning">
									<input type="text" class="form-control"
										...
										value="${FoodStorageAirColdFormMap.temperatureMax }"
										placeholder="请输入：最大值">
								</div>
							</div>
						</div>
							...
							<div class="col-md-12">
								<div class="has-warning">
									<input type="text" class="form-control"
										...
										value="${FoodStorageAirColdFormMap.temperatureMin }"
										placeholder="请输入：最小值">
								</div>
							</div>
						</div>
							...
							<div class="col-md-12">
								<div class="has-warning">
									<input type="text" class="form-control"
										...
										value="${FoodStorageAirColdFormMap.temperatureAvg }"
										placeholder="请输入：平均值">
								</div>
							</div>
						</div>
					...
					<div class="col-md-10">
						...
						<div class="form-group col-md-3">
							<div class="col-md-12">
								<div class="has-warning">
									<input type="text" class="form-control"
										name="FoodStorageAirColdFormMap.wetMax"
										value="${FoodStorageAirColdFormMap.wetMax }" placeholder="请输入：最大值">
								</div>
							</div>
						</div>
						...
						<div class="form-group col-md-3">
							<div class="col-md-12">
								<div class="has-warning">
									<input type="text" class="form-control"
										name="FoodStorageAirColdFormMap.wetMin"
										value="${FoodStorageAirColdFormMap.wetMin }" placeholder="请输入：最小值">
								</div>
							</div>
						</div>
						<div class="form-group col-md-3">
							<div class="col-md-12">
								<div class="has-warning">
									<input type="text" class="form-control"
										name="FoodStorageAirColdFormMap.wetAvg"
										value="${FoodStorageAirColdFormMap.wetAvg }" placeholder="请输入：平均值">
								</div>
							</div>
						</div>
							...
							<div class="col-md-12">
								<div class="has-warning">
									<input type="text" class="form-control"
										...
										value="${FoodStorageAirColdFormMap.ftemperatureMax_b }"
										placeholder="请输入：最大值">
								</div>
							</div>
						</div>
							...
							<div class="col-md-12">
								<div class="has-warning">
									<input type="text" class="form-control"
										...
										value="${FoodStorageAirColdFormMap.ftemperatureMin_b }"
										placeholder="请输入：最小值">
								</div>
							</div>
						</div>
							...
							<div class="col-md-12">
								<div class="has-warning">
									<input type="text" class="form-control"
										...
										value="${ FoodStorageAirColdFormMap.ftemperatureAvg_b}"
										placeholder="请输入：平均值">
								</div>
							</div>
						</div>
							...
							<div class="col-md-12">
								<div class="has-warning">
									<input type="text" class="form-control"
										...
										value="${FoodStorageAirColdFormMap.ftemperature_ladderMax_b }"
							...
							<div class="col-md-12">
								<div class="has-warning">
									<input type="text" class="form-control"
										...
										value="${FoodStorageAirColdFormMap.ftemperatureMax_a }"
										placeholder="请输入：最大值">
								</div>
							</div>
						</div>
							...
							<div class="col-md-12">
								<div class="has-warning">
									<input type="text" class="form-control"
										...
										value="${FoodStorageAirColdFormMap.ftemperatureMin_a }"
										placeholder="请输入：最小值">
								</div>
							</div>
						</div>
							...
							<div class="col-md-12">
								<div class="has-warning">
									<input type="text" class="form-control"
										...
										value="${FoodStorageAirColdFormMap.ftemperatureAvg_a }"
										placeholder="请输入：平均值">
								</div>
							</div>
						</div>
							...
							<div class="col-md-12">
								<div class="has-warning">
									<input type="text" class="form-control"
										...
										value="${FoodStorageAirColdFormMap.ftemperature_ladderMax_a }"
										placeholder="请输入：℃/米粮层厚度或水分%/米粮层厚度">
								</div>
							</div>
						</div>
			...
			<div class="form-group col-md-12"
					...
					<div class="col-md-9">
						<div class="has-warning">
							<input type="text" class="form-control"
								...
								value="${FoodStorageAirColdFormMap.elecAmount }"
					...
					<div class="col-md-9">
						<div class="has-warning">
							<input type="text" class="form-control"
								...
								value="${FoodStorageAirColdFormMap.elecAmountPerHour }"
				...
				<div class="form-group col-md-6">
					...
					<div class="col-md-9">
						<div class="has-warning">
							<input type="text" class="form-control"
								name="FoodStorageAirColdFormMap.charge"
								value="${FoodStorageAirColdFormMap.charge }" placeholder="请输入：负责人">
						</div>
					</div>
				</div>
				<div class="form-group col-md-6">
					...
					<div class="col-md-9">
						<div class="has-warning">
							<input type="text" class="form-control"
								name="FoodStorageAirColdFormMap.operator"
								value="${FoodStorageAirColdFormMap.operator }" placeholder="请输入：操作人">
						</div>
					</div>
				</div>
				<div class="form-group col-md-6">
					...
					<div class="col-md-9">
						<div class="has-warning">
							<textarea type="text" class="form-control"
								name="FoodStorageAirColdFormMap.comment" placeholder="请输入：备注">${FoodStorageAirColdFormMap.comment}</textarea>
						</div>
					</div>
				</div>
				<div class="form-group col-md-6">
	...
	<script type="text/javascript">
		...
		new myselect({
			...
			option_html : [ "wName" ],
			option_html_prefix : ",",
			selected_val:"${FoodStorageAirColdFormMap.location}"
		...
		function ck() {
			new myselect({
				...
				option_html : [ "wName" ],
				option_html_prefix : ",",
				selected_val:"${FoodStorageAirColdFormMap.houseid}"
			}, function() {
				//给change事件添加方法
				clear_content;
				getStorage();
