					...
					<div class="col-md-9">
						<div class="has-warning">
							<input type="text" class="form-control"
								...
								value="${FoodStorageSteamFormMap.names }" placeholder="请输入：药剂名称" maxlength="64">
						</div>
					</div>
				</div>
					...
					<div class="col-md-9">
						<div class="has-warning">
							<input type="text" class="form-control"
								...
								placeholder="请输入：粮食水分(%)" maxlength="64">
						</div>
					</div>
				</div>
				<div class="form-group col-md-6">
					...
					<div class="col-md-9">
						<div class="has-warning">
							<input type="text" class=" form-control "
								...
								placeholder="请输入：施药方法" maxlength="64">
						</div>
					</div>
				</div>
				<div class="form-group col-md-6">
					...
					<div class="col-md-9">
						<div class="has-warning">
							<input type="text" class="form-control"
								...
								placeholder="请输入：粮食杂质(%)" maxlength="64">
						</div>
					</div>
				</div>
				<div class="form-group col-md-6">
					...
					<div class="col-md-9">
						<div class="has-warning">
							<input type="text" class="form-control "
								...
								placeholder="请输入：施药人数(人)" maxlength="10">
						</div>
					</div>
				</div>
				<div class="form-group col-md-6">
					...
					<div class="col-md-9">
						<div class="has-warning">
							<input type="text" class="form-control"
								...
								value="${FoodStorageSteamFormMap.weather }" placeholder="请输入：天气" maxlength="64">
						</div>
					</div>
				</div>
				<div class="form-group col-md-6">
					...
					<div class="col-md-9">
						<div class="has-warning">
							<input type="text" class="form-control"
								...
								value="${ FoodStorageSteamFormMap.way}" placeholder="请输入：密闭方式" maxlength="64">
						</div>
					</div>
				</div>
				<div class="form-group col-md-6">
					...
					<div class="col-md-9">
						<div class="has-warning">
							<input type="text" class="form-control"
								...
								value="${FoodStorageSteamFormMap.days }" placeholder="请输入：仓温（℃）" maxlength="10">
						</div>
					</div>
				</div>
				<div class="form-group col-md-6">
					...
					<div class="col-md-9">
						<div class="has-warning">
							<input type="text" class="form-control"
								...
								placeholder="请输入：密闭时间(天)" maxlength="10">
						</div>
					</div>
				</div>
			</div>
					...
					<div class="col-md-9">
						<div class="has-warning">
							<input type="text" class="form-control"
								...
								placeholder="请输入：合计（m3）" maxlength="64">
						</div>
					</div>
				</div>
					...
					<div class="col-md-9">
						<div class="has-warning">
							<input type="text" class="form-control"
								...
								placeholder="请输入：培养天数(天)" maxlength="10">
						</div>
					</div>
				</div>
			</div>
					...
					<div class="col-md-9">
						<div class="has-warning">
							<input type="text" class="form-control"
								...
								placeholder="请输入：熏蒸负责人" maxlength="64">
						</div>
					</div>
				</div>
				<div class="form-group col-md-4">
					...
					<div class="col-md-9">
						<div class="has-warning">
							<input type="text" class="form-control"
								...
								placeholder="请输入：安全员" maxlength="64">
						</div>
					</div>
				</div>
				<div class="form-group col-md-4">
					...
					<div class="col-md-9">
						<div class="has-warning">
							<input type="text" class="form-control"
								...
								placeholder="请输入：记录人" maxlength="64">
						</div>
					</div>
				</div>
