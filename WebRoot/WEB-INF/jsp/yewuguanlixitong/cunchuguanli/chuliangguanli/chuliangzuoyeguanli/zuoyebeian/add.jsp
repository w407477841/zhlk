...
<body style="background-color:#d9edf7">
	<div class=" col-md-12">
		<form id="form" name="form" method="post"
			action="${ctx}/foodStorageManager/addSteamPlan.shtml">
			<input type="hidden" name="token" value="${token}"> <input
				type="hidden" id="pMsg" name="FoodStorageSteamPlanFormMap.peopleMsg">
			<input type="hidden" id="tMsg"
				name="FoodStorageSteamPlanFormMap.targetMsg">
			<div class="form-group col-md-12"
					...
					<div class="col-md-9">
						<div class="has-warning">
							<input type="text" class=" form-control "
								name="FoodStorageSteamPlanFormMap.charge" placeholder="请输入：负责人">
						</div>
					</div>
				</div>
				...
				<div class="form-group col-md-6">
					...
					<div class="col-md-9">
						<div class="has-warning">
							<input type="text" class=" form-control "
								name="FoodStorageSteamPlanFormMap.east" placeholder="请输入：警戒距离-东">
						</div>
					</div>
				</div>
				...
				<div class="form-group col-md-6">
					...
					<div class="col-md-9">
						<div class="has-warning">
							<input type="text" class=" form-control "
								name="FoodStorageSteamPlanFormMap.west" placeholder="请输入：警戒距离-西">
						</div>
					</div>
				</div>
				...
				<div class="form-group col-md-6">
					...
					<div class="col-md-9">
						<div class="has-warning">
							<input type="text" class=" form-control "
								name="FoodStorageSteamPlanFormMap.filler" placeholder="请输入：填表人">
						</div>
					</div>
				</div>
			...
			<div class="form-group col-md-12"
					...
					<div class="col-md-9">
						<div class="has-warning">
							<input type="text" class=" form-control" id="dateTime1"
								name="FoodStorageSteamPlanFormMap.mDate" placeholder="请输入：有效期">
						</div>
					</div>
				</div>
				...
				<div class="form-group col-md-6">
					...
					<div class="col-md-9">
						<div class="has-warning">
							<input type="text" class=" form-control "
								name="FoodStorageSteamPlanFormMap.mPlace" placeholder="请输入：暂存地点">
						</div>
					</div>
				</div>
				...
				<div class="form-group col-md-6">
					...
					<div class="col-md-9">
						<div class="has-warning">
							<input type="text" class=" form-control "
								name="FoodStorageSteamPlanFormMap.mPerson" placeholder="请输入：领取人">
						</div>
					</div>
				</div>
					...
					<div class="col-md-9">
						<div class="has-warning">
							<input type="text" class=" form-control " id="dateTime2"
								name="FoodStorageSteamPlanFormMap.mTime" placeholder="请输入：领取时间">
						</div>
					</div>
				</div>
					...
					<div class="col-md-9">
						<div class="has-warning">
							<textarea type="text" class=" form-control "
								...
								placeholder="请输入：药剂残渣处理说明"></textarea>
						</div>
					</div>
				</div>
				<div class="form-group col-md-6">
					...
					<div class="col-md-9">
						<div class="has-warning">
							<textarea type="text" class=" form-control "
								name="FoodStorageSteamPlanFormMap.remark"
								placeholder="请输入：备注"></textarea>
						</div>
					</div>
				</div>
			...
			<div class="form-group col-md-12" id="peopleMsg"
				...
				<div class="form-group col-md-6">
					<div class="col-md-3 div_label">姓名<span>*</span></div>
					<div class="col-md-9">
						<div class="has-warning">
				...
				<div class="form-group col-md-6">
					<div class="col-md-3 div_label">职务<span>*</span></div>
					<div class="col-md-9">
						<div class="has-warning">
							<input type="text" class="form-control" data-pass=true
								placeholder="请输入：职务">
				...
				<div class="form-group col-md-6">
					<div class="col-md-3 div_label">职业资质<span>*</span></div>
					<div class="col-md-9">
						<div class="has-warning">
							<input type="text" class="form-control" data-pass=true
			...
			<div id="targetMsg" class="form-group col-md-12"
				...
				<div class="form-group col-md-6">
					...
					<div class="col-md-9">
						<div class="has-warning">
							<input type="text" id="start" class="form-control validate"
				...
				<div class="form-group col-md-6">
					...
					<div class="col-md-9">
						<div class="has-warning">
							<input type="text" id="start1" class="form-control validate"
					...
					<div class="col-md-9">
						<div class="has-warning">
							<input type="text" id="start2" data-pass=true
								class="form-control validate" placeholder="请输入：计划熏蒸时间">
						</div>
					</div>
				</div>
	...
	<script type="text/javascript">
		...
		new myselect({
			...
			//给change事件添加方法
			$("#medicineType").val($("#selectMedicine").find("option:selected").val().split(",")[2]);
		}, function() {
			//初始化执行方法
		});
				...
				.on(
						...
						function() {
							...
							if (typeof vaildateSelects == "function"
								...
								if (!rs.pass) {
									var returnVal = [ $("#selectVariety").find("option:selected").text(),
											$("#selectLocation").val(),
											$("#selectCk").val() ]
											.concat(rs.results);
