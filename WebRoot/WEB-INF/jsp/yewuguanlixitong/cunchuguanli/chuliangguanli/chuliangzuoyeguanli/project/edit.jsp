...
<body style="background-color:#d9edf7">
	...
	<div class=" col-md-12">
		<form id="form" name="form" method="post"
			...
			<input type="hidden" name="token" value="${token}"> <input
				...
				value="${FoodStorageProjectFormMap.ctime}"> <input
				type="hidden" name="FoodStorageProjectFormMap.id"
				value="${FoodStorageProjectFormMap.id}"> <input
				type="hidden" name="FoodStorageProjectFormMap.version"
			...
			<div class="form-group col-md-12">
					...
					<div class="col-md-10">
						<div class="has-warning">
							<select id="selectRs" data-rel="chosen"
								...
								<option value=""></option>
								<c:if test="${FoodStorageProjectFormMap.type == null }">
									<option value="0">通风</option>
									<option value="1">熏蒸</option>
									<option value="2">冷却</option>
								</c:if>
								<c:if test="${FoodStorageProjectFormMap.type ==0 }">
									<option value="0" selected="selected">通风</option>
									<option value="1">熏蒸</option>
									<option value="2">冷却</option>
								</c:if>
								<c:if test="${FoodStorageProjectFormMap.type ==1 }">
									<option value="0">通风</option>
									<option value="1" selected="selected">熏蒸</option>
									<option value="2">冷却</option>
								</c:if>
								<c:if test="${FoodStorageProjectFormMap.type ==2 }">
									<option value="0">通风</option>
									<option value="1">熏蒸</option>
									<option value="2" selected="selected">冷却</option>
								</c:if>
					...
					<div class="col-md-10">
						<div class="has-warning">
							<input id="varietyName" type="text" readonly="readonly"
								class="form-control" value="${FoodStorageProjectFormMap.text }">
							<input id="varietyId" type="hidden"
								name="FoodStorageProjectFormMap.breed"
								value="${FoodStorageProjectFormMap.breed }">
						</div>
					</div>
				</div>
					...
					<div class="col-md-10">
						<div class="has-warning">
							<input type="text" id="currentWeight" class="form-control"
								...
								value="${FoodStorageProjectFormMap.amount }"
				...
				<div class="form-group col-md-6">
					...
					<div class="col-md-10">
						<div class="has-warning">
							<input type="text" class=" form-control "
								name="FoodStorageProjectFormMap.chonghai"
								value="${FoodStorageProjectFormMap.chonghai }"
								placeholder="请输入：主要虫害" maxlength="64">
						</div>
					</div>
				</div>
				<div class="form-group col-md-6">
					...
					<div class="col-md-10">
						<div class="has-warning">
							<input type="text" class="form-control"
								...
								value="${FoodStorageProjectFormMap.perWeight }"
					...
					<div class="col-md-10">
						<div class="has-warning">
							<input type="text" class="form-control " id="waInnerLong"
								name="FoodStorageProjectFormMap.length"
								value="${FoodStorageProjectFormMap.length }"
								placeholder="请输入：仓廒长(米)" maxlength="10">
						</div>
					</div>
				</div>
				<div class="form-group col-md-6">
					...
					<div class="col-md-10">
						<div class="has-warning">
							<input type="text" class="form-control"
								name="FoodStorageProjectFormMap.width" id="waInnerWidth"
								value="${FoodStorageProjectFormMap.width }"
								placeholder="请输入：仓廒宽(米)" maxlength="10">
						</div>
					</div>
				</div>
				...
				<div class="form-group col-md-6">
					...
					<div class="col-md-10">
						<div class="has-warning">
							<input type="text" class="form-control"
								name="FoodStorageProjectFormMap.height" id="waDesignHeight"
								value="${FoodStorageProjectFormMap.height }"
								placeholder="请输入：仓廒高(米)" maxlength="10">
						</div>
					</div>
				</div>
				<div class="form-group col-md-6">
					...
					<div class="col-md-10">
						<div class="has-warning">
							<input type="text" class="form-control" id="sf"
								name="FoodStorageProjectFormMap.waterPer"
								value="${FoodStorageProjectFormMap.waterPer }"
								placeholder="请输入：水分" maxlength="10">
						</div>
					</div>
				</div>
				<div class="form-group col-md-6">
					...
					<div class="col-md-10">
						<div class="has-warning">
							<input type="text" class="form-control"
								...
								value="${FoodStorageProjectFormMap.acturalHeight }"
					...
					<div class="col-md-10">
						<div class="has-warning">
							<input type="text" class="form-control"
								...
								value="${FoodStorageProjectFormMap.upperTemperature }"
					...
					<div class="col-md-10">
						<div class="has-warning">
							<input type="text" class="form-control"
								...
								value="${FoodStorageProjectFormMap.footTemperature }"
				...
				<div class="form-group col-md-6">
					...
					<div class="col-md-10">
						<div class="has-warning">
							<input type="text" class="form-control"
								name="FoodStorageProjectFormMap.wet"
								value="${FoodStorageProjectFormMap.wet }"
								placeholder="请输入：大气湿度(%)" maxlength="10">
						</div>
					</div>
				</div>
				<div class="form-group col-md-6">
					...
					<div class="col-md-10">
						<div class="has-warning">
							<input type="text" class="form-control"
								...
								value="${FoodStorageProjectFormMap.innerWet }"
				...
				<div class="form-group col-md-6">
					...
					<div class="col-md-10">
						<div class="has-warning">
							<input type="text" class="form-control"
								name="FoodStorageProjectFormMap.qiwen"
								value="${FoodStorageProjectFormMap.qiwen }"
					...
					<div class="col-md-10">
						<div class="has-warning">
							<input type="text" class="form-control" id="waAeration"
								name="FoodStorageProjectFormMap.windForm"
								value="${FoodStorageProjectFormMap.windForm }"
								placeholder="请输入：通风形式" maxlength="64">
						</div>
					</div>
				</div>
					...
					<div class="col-md-10">
						<div class="has-warning">
							<input type="text" class="form-control" id="waFumigate"
								...
								value="${FoodStorageProjectFormMap.steamForm }"
					...
					<div class="col-md-10">
						<div class="has-warning">
							<input type="text" class="form-control" id="waFumigate"
								...
								value="${FoodStorageProjectFormMap.bId }"
				...
				<div class="form-group col-md-6" id="lengque">
					...
					<div class="col-md-10">
						<div class="has-warning">
							<input type="text" class="form-control"
								name="FoodStorageProjectFormMap.coldForm"
								value="${FoodStorageProjectFormMap.coldForm }"
								placeholder="请输入：冷却形式" maxlength="64">
						</div>
					</div>
				</div>
				<div class="form-group col-md-6" id="tongfengmudi">
					...
					<div class="col-md-10">
						<div class="has-warning">
							<input type="text" class="form-control"
								name="FoodStorageProjectFormMap.purpose"
								value="${FoodStorageProjectFormMap.purpose }"
					...
					<div class="col-md-10">
						<div class="has-warning">
							<input id="start" type="text" class="form-control "
								name="FoodStorageProjectFormMap.times"
								value="${FoodStorageProjectFormMap.times }"
					...
					<div class="col-md-10">
						<div class="has-warning">
							<input id="start1" type="text" class="form-control "
								name="FoodStorageProjectFormMap.timee"
								value="${FoodStorageProjectFormMap.timee }"
					...
					<div class="col-md-11">
						<div class="has-warning">
							<textarea class="form-control " rows="4" cols="10"
								...
								maxlength="128">${FoodStorageProjectFormMap.content }</textarea>
						</div>
					</div>
				</div>
			</div>
	...
	<script type="text/javascript">
		...
		new myselect({
			...
			option_html : [ "wName" ],
			option_html_prefix : ",",
			selected_val : "${FoodStorageProjectFormMap.location}"
		...
		function ck() {
			new myselect({
				...
				option_html : [ "wName" ],
				option_html_prefix : ",",
				selected_val : "${FoodStorageProjectFormMap.houseid}"
			}, function() {
				//给change事件添加方法
				$("#selectVariety").html("");
