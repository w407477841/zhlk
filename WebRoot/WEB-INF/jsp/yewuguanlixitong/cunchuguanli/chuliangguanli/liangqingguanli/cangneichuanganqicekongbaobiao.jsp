...
var rootPath="${pageContext.servletContext.contextPath}";
  ...
  <div class="row">
    ...
    <div class="box-header well" data-original-title="">
        <h2><i class="glyphicon glyphicon-list"></i> 仓内传感器测控报表</h2>
...
<script type="text/javascript" src="js/system/yewuguanlixiytong/cunchuguanli/chuliangguanli/liangqingguanli/cangneichuanganqicekongbaobiao.js"></script>
<script type="text/javascript">
