						...
						<div class=" col-md-12">
							...
							<div class="form-group col-md-3">
									<select id="selectLocation" data-rel="chosen"
											...
											name="cangFangWeiXiuFormMap.wLNo" style="width:100%">
											<option value=""></option>
										</select>
								</div>
								<div class="form-group col-md-3">
										<select class="form-control" id="warehouse"
											name="cangFangWeiXiuFormMap.waNo" data-rel="chosen"
											data-placeholder="仓号">
										</select>
								</div>
							</form>
...
<!--/row-->
<script type="text/javascript"
	src="js/system/yewuguanlixiytong/cunchuguanli/cangkuguanli/cangfangweixiulist.js"></script>
<script type="text/javascript">
