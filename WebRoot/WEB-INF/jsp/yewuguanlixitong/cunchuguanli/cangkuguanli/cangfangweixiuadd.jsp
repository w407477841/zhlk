...
<body style="background-color:#d9edf7">
	...
	<div class=" col-md-12">
		<form id="form" name="form" method="post"
			action="${ctx}/cangfangweixiu/add.shtml">
			...
			<div class="form-group col-md-6">
				...
				<div class="col-md-10">
					<div class="has-warning">
						<input type="text" class="form-control easyui-validatebox" missingMessage="请输入保修到期日" data-options="required:true" id="dateformat"
				...
				<div class="col-md-10">
					<div class="has-warning">
						<input type="text" class="form-control"
							...
							placeholder="请输入 ：保修年限(年)" maxlength="10">
					</div>
				</div>
			</div>
