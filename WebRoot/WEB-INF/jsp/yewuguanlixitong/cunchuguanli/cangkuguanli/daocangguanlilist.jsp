				...
				<div class="alert alert-info">
					<div class="row">
							...
							<form id="searchForm" name="searchForm">
								<div class="form-group col-md-3">
									<input type="text" class="form-control"
										name="daoCangGuanLiFormMap.wgtBill" value=""
										placeholder="倒仓单号">
								</div>
							</form>
						</div>
						...
						<a class="btn btn-primary" href="javascript:void(0)"
								id="lookFun" style="text-shadow: black 5px 3px 3px;"> <i
								class="glyphicon glyphicon-search icon-white"></i> 查看
							</a>
							<a class="btn btn-info" href="javascript:void(0)" id="addFun"
								style="text-shadow: black 5px 3px 3px;"> <i
								class="glyphicon glyphicon-retweet icon-white"></i> 倒仓
							</a> 
						</div>
					</div>
				</div>
...
<script type="text/javascript"
	src="js/system/yewuguanlixiytong/cunchuguanli/cangkuguanli/daocangguanli.js"></script>
<script type="text/javascript">
