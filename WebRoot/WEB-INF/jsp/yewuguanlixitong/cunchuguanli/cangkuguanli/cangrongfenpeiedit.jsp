...
<body style="background-color:#d9edf7">
	...
	<div class=" col-md-12">
		<form id="form" name="form" method="post"
			action="${ctx}/cangrongfenpei/edit.shtml">
			<input type="hidden" name="cangRongFenPeiFormMap.id"
				value="${cangRongFenPeiFormMap.id }"> <input type="hidden"
				name="cangRongFenPeiFormMap.version"
				value="${cangRongFenPeiFormMap.version }"> <input
				...
				<div class="col-md-9">
					<div class="has-warning">
						<input type="text" class="form-control easyui-validatebox" missingMessage="请输入内墙长" data-options="required:true" id="innerlong"
							...
							value="${cangRongFenPeiFormMap.wscInnerLong }"
				...
				<div class="col-md-9">
					<div class="has-warning">
						<input type="text" class="form-control easyui-validatebox" missingMessage="请输入内墙宽" data-options="required:true" id="innerwidth"
							...
							value="${cangRongFenPeiFormMap.wscInnerWidth }"
				...
				<div class="col-md-9">
					<div class="has-warning">
						<input type="text" class="form-control easyui-validatebox" missingMessage="请输入堆粮限高" data-options="required:true" id="limitheight"
							...
							value="${cangRongFenPeiFormMap.wscLimitHeight }"
				...
				<div class="col-md-9">
					<div class="has-warning">
						<input type="text" class="form-control easyui-validatebox" missingMessage="请输入粳稻堆放密度" data-options="required:true" id="JaponicaRiceDensity"
							...
							value="${cangRongFenPeiFormMap.wscJaponicaRiceDensity }"
				...
				<div class="col-md-9">
					<div class="has-warning">
						<input type="text" class="form-control easyui-validatebox" missingMessage="请输入小麦堆放密度" data-options="required:true" id="WheatDensity"
							...
							value="${cangRongFenPeiFormMap.wscWheatDensity }"
				...
				<div class="col-md-9">
					<div class="has-warning">
						<input type="text" class="form-control" id="JaponicaRiceWeight"
							...
							value="${cangRongFenPeiFormMap.wscJaponicaRiceWeight }">
					</div>
				</div>
			</div>
			<div class="form-group col-md-6">
				...
				<div class="col-md-9">
					<div class="has-warning">
						<input type="text" class="form-control" id="WheatWeight"
							...
							value="${cangRongFenPeiFormMap.wscWheatWeight }">
					</div>
				</div>
			</div>
	...
	<script type="text/javascript">
		...
		var sel = new myselect({
			...
			option_html : [ "wName" ],
			option_html_prefix : ",",
			selected_val : ${cangRongFenPeiFormMap.wLocation}
		}, function() {
			//给change事件添加方法
			$("#warehouseName").html("");
		...
		function findWarehouse(location) {
			new myselect({
				...
				option_html : [ "wName" ],
				option_html_prefix : ",",
				selected_val : ${cangRongFenPeiFormMap.wscId}
			}, function() {
				//给change事件添加方法
			}, function() {
				//初始化执行方法
