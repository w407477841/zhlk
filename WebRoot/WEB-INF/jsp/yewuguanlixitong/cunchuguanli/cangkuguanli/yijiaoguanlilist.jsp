			...
			<div class="box-inner">
				...
				<div class="box-content" id="page">
					...
					<div class="row">
							...
							name="searchForm">
								<div class="form-group col-md-3">
									<select id="selectLocation" data-rel="chosen"
											...
											name="yiJiaoGuanLiFormMap.wLNo" style="width:100%">
											<option value=""></option>
										</select>
								</div>
								<div class="form-group col-md-3">
										<select class="form-control" id="warehouse"
											name="yiJiaoGuanLiFormMap.wNo" data-rel="chosen"
											data-placeholder="仓号">
										</select>
								</div>
						</form>
						...
						</a> <a class="btn btn-info" href="javascript:void(0)" id="tranFun"
							style="text-shadow: black 5px 3px 3px;"> <i
							class="glyphicon glyphicon-retweet icon-white"></i> 移交
						</a> <a class="btn btn-danger" href="javascript:void(0)" id="deleFun"
							style="text-shadow: black 5px 3px 3px;"> <i
							class="glyphicon glyphicon-remove icon-white"></i> 删除
						</a> <a class="btn btn-info" href="javascript:void(0)" id="lookFun"
							style="text-shadow: black 5px 3px 3px;"> <i
...
<script type="text/javascript"
	src="js/system/yewuguanlixiytong/cunchuguanli/cangkuguanli/yijiaoguanlilist.js"></script>
<script type="text/javascript">
