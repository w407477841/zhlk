...
<body style="background-color:#d9edf7">
	...
	<div class=" col-md-12">
		<form id="form" name="form" method="post"
			action="${ctx}/daxingshebeikucun/edit.shtml">
			<input type="hidden" name="daXingSheBeiFormMap.id"
				value="${daXingSheBeiFormMap.id }"> <input type="hidden"
				name="daXingSheBeiFormMap.version"
				value="${daXingSheBeiFormMap.version }"> <input
			...
			<div class=" col-md-12">
					...
					<div class="col-md-10">
						<div class="has-warning">
							<input type="text" class="form-control easyui-validatebox"
								missingMessage="请输入设备编号" data-options="required:true"
								id="userName" name="daXingSheBeiFormMap.leNo"
								value="${daXingSheBeiFormMap.leNo }" placeholder="请输入 ：设备编号"
								maxlength="32">
						</div>
					</div>
				</div>
				<div class="form-group col-md-6">
					...
					<div class="col-md-10">
						<div class="has-warning">
							<input type="text" class="form-control easyui-validatebox"
								missingMessage="请输入设备名称" data-options="required:true"
								id="accountName" name="daXingSheBeiFormMap.leName"
								value="${daXingSheBeiFormMap.leName }" placeholder="请输入 ：设备名称"
								maxlength="64">
						</div>
					</div>
				</div>
					...
					<div class="col-md-10">
						<div class="has-warning">
							<input type="text" class="form-control" id="description"
								name="daXingSheBeiFormMap.leStandard"
								value="${daXingSheBeiFormMap.leStandard }"
					...
					<div class="col-md-10">
						<div class="has-warning">
							<input type="text" class="form-control"
								...
								value="${daXingSheBeiFormMap.leWorth }"
					...
					<div class="col-md-10">
						<div class="has-warning">
							<input type="text" class="form-control"
								...
								name="daXingSheBeiFormMap.leMotorsNumber"
								value="${daXingSheBeiFormMap.leMotorsNumber }"
					...
					<div class="col-md-10">
						<div class="has-warning">
							<input type="text" class="form-control"
								...
								name="daXingSheBeiFormMap.lePower"
								value="${daXingSheBeiFormMap.lePower }"
					...
					<div class="col-md-10">
						<div class="has-warning">
							<input type="text" class="form-control easyui-validatebox"
								...
								name="daXingSheBeiFormMap.leTelephone"
								value="${daXingSheBeiFormMap.leTelephone }"
					...
					<div class="col-md-10">
						<div class="has-warning">
							<input type="text" class="form-control"
								...
								value="${daXingSheBeiFormMap.leZipCode }" placeholder="请输入 ：邮编"
								maxlength="6">
						</div>
					</div>
				</div>
				<div class="form-group col-md-6">
					...
					<div class="col-md-10">
						<div class="has-warning">
							<input type="text" class="form-control easyui-validatebox"
								missingMessage="请输入始用日期" data-options="required:true"
								id="dateformat" placeholder="请输入 ：始用日期"
								name="daXingSheBeiFormMap.leUsedDate"
								value="${daXingSheBeiFormMap.leUsedDate }">
						</div>
					</div>
				</div>
				<div class="form-group col-md-12">
					...
					<div class="col-md-11">
						<div class="has-warning">
							<input type="text" class="form-control"
								name="daXingSheBeiFormMap.leLocation"
								value="${daXingSheBeiFormMap.leLocation }"
				...
				<div class="form-group col-md-12">
					...
					<div class="col-md-11">
						<div class="has-warning">
							<input type="text" class="form-control"
								name="daXingSheBeiFormMap.leManufacturingUnit"
								value="${daXingSheBeiFormMap.leManufacturingUnit }"
				...
				<div class="form-group col-md-12">
					...
					<div class="col-md-11">
						<div class="has-warning">
							<input type="text" class="form-control"
								name="daXingSheBeiFormMap.leManufacturingAddress"
								value="${daXingSheBeiFormMap.leManufacturingAddress }"
				...
				<input type="hidden" id="fjid" name="daXingSheBeiFormMap.leSon"
					value="${daXingSheBeiFormMap.leSon}">
	...
	<script type="text/javascript">
		...
		var sel = new myselect({
			...
			option_html : [ "wName" ],
			option_html_prefix : ",",
			selected_val : ${daXingSheBeiFormMap.leWLNo}
		}, function() {
			//给change事件添加方法
		}, function() {
			//初始化执行方法
		...
		var sele = new myselect({
			...
			option_html : [ "text" ],
			option_html_prefix : ",",
			selected_val : "${daXingSheBeiFormMap.leType}"
		}, function() {
			//给change事件添加方法
		}, function() {
			//初始化执行方法
		...
		var selec = new myselect({
			...
			option_html : [ "text" ],
			option_html_prefix : ",",
			selected_val : ${daXingSheBeiFormMap.leUnit}
		}, function() {
			//给change事件添加方法
		}, function() {
			//初始化执行方法
