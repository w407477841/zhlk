...
<body style="background-color:#d9edf7">
	...
	<div class=" col-md-12">
		<form id="form" name="form" method="post"
			action="${ctx}/mobile/role/add.shtml">
				...
				<div class="col-md-10">
					<div class="has-warning">
						<input type="text" class="form-control easyui-validatebox"
							...
							name="mobileRoleFormMap.name" value="" placeholder="请输入 ：角色名称 ">
					</div>
				</div>
			</div>
			<div class="form-group col-md-6">
				...
				<div class="col-md-10">
					<div class="has-warning">
						<input type="text" class="form-control"
							id="resUrl" name="mobileRoleFormMap.roleKey" value=""
			...
			<div class="form-group col-md-12">
				...
				<div class="col-md-11">
					...
					<textarea rows="4" cols="20" class="form-control" name="mobileRoleFormMap.description"
							value="" placeholder="请输入 ：描述 "></textarea>
					</div>
				</div>
			</div>
			<div class="form-group col-md-12">
