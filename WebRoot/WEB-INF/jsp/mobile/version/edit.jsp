...
<body style="background-color:#d9edf7">
	...
	<div class=" col-md-12">
		<form id="form" name="form" method="post"
			action="${ctx}/version/edit.shtml">
			<input type="hidden" name="token" value="${token }">
			<input type="hidden" name="versionFormMap.id" value="${versionFormMap.id }">
				...
				<div class="col-md-10">
					<div class="has-warning">
						<select class="form-control"
							...
							<c:if test="${versionFormMap.type == 'Android' }">
							<option value="Android" selected="selected">Android</option>
							</c:if>
							<c:if test="${versionFormMap.type != 'Android' }">
							<option value="Android">Android</option>
							</c:if>
							<c:if test="${versionFormMap.type == 'IOS' }">
			...
			<div class="form-group col-md-6">
				...
				<div class="col-md-10">
					<div class="has-warning">
						<input type="text" class="form-control easyui-validatebox" value="${versionFormMap.version }"
				...
				<div class="col-md-10">
					<div class="has-warning">
						<input type="text" class="form-control easyui-validatebox"
							data-options="required:true"  name="versionFormMap.url" value="${versionFormMap.url }"
				...
				<div class="col-md-11">
					<div class="has-warning">
						<textarea rows="4" cols="20" class="form-control" name="versionFormMap.scription"
							placeholder="请输入 ：工程描述" maxlength="255">${versionFormMap.scription }</textarea>
					</div>
				</div>
			</div>
