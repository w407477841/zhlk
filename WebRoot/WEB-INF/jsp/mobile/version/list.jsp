					...
					<div class="row">
							...
							<form id="searchForm" name="searchForm">
								...
								<div class="form-group col-md-3">
										<select class="form-control" id="warehouse"
											name="warehouseFormMap.wNo" data-rel="chosen"
											data-placeholder="仓号">
										</select>
								</div>
							</form>
						...
						<div class=" col-md-12">
							...
							<a class="btn btn-primary" href="javascript:void(0)"
									...
									class="glyphicon glyphicon-open icon-white"></i> 上传文件
							</a>
							<a class="btn btn-primary" href="javascript:void(0)"
									id="code" style="text-shadow: black 5px 3px 3px;"> <i
									class="glyphicon glyphicon-qrcode"></i> 二维码
							</a>
						</div>
					</div>
				</div>
...
<script type="text/javascript"
	src="js/system/mobile/version/list.js"></script>
<script type="text/javascript">
