...
function addUI(){
	pageii = layer.open({
		...
		area : [ "1200px", "600px"],
		offset:"40px",
		content : rootPath + '/canzhachuli/addUI.shtml',
		end :function(){
...
function editUI(){
	...
	pageii = layer.open({
		...
		area : [ "1200px", "600px" ],
		offset:"40px",
		content : rootPath + '/canzhachuli/editUI.shtml?id='+selectRow.id,
		end :function(){
			grid.datagrid("reload");
		}
	});
...
function del(){
	...
	layer.confirm('确认删除？', function(index) {
		var url = rootPath + '/canzhachuli/delete.shtml';
