...
$(function() {
	...
	grid = $('#magazineGrid').datagrid({
		url : rootPath+'/qualityManager/findInputByPage.shtml',
		method : 'POST',
...
function addUI(){
	pageii = layer.open({
		...
		area : [ "1200px", "600px"],
		offset:"40px",
		content : rootPath + '/qualityManager/addInputCheckUI.shtml',
		end :function(){
...
function editUI(){
	...
	pageii = layer.open({
		...
		area : [ "1200px", "600px" ],
		offset:"40px",
		content : rootPath + '/qualityManager/editInputCheckUI.shtml?id='+selectRow.id,
		end :function(){
			grid.datagrid("reload");
		}
	});
