...
$(function() {
	...
	grid = $('#magazineGrid').datagrid({
		url : 'chukufangan/findByPage.shtml',
		method : 'POST',
...
function addUI(){
	pageii = layer.open({
		...
		area : [ "1200px", "600px"],
		offset:"40px",
		content : rootPath + '/chukufangan/addUI.shtml',
		end :function(){
...
function editUI(){
	...
	pageii = layer.open({
		...
		area : [ "1200px", "600px" ],
		offset:"40px",
		content : rootPath + '/chukufangan/editUI.shtml?id='+selectRow.id,
		end :function(){
			grid.datagrid("reload");
		}
	});
...
function del(){
	...
	layer.confirm('确认删除？', function(index) {
		var url = rootPath + '/chukufangan/delete.shtml';
...
function look(){
	...
	pageii = layer.open({
		...
		area : [ "1200px", "600px" ],
		offset:"40px",
		content : rootPath + '/chukufangan/look.shtml?id='+selectRow.id,
		end :function(){
			grid.datagrid("reload");
		}
	});
