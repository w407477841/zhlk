...
$(function(){
	treeTable=$('#treeTable').treegrid({
			url: 'resources/findResTreeGrid.shtml',
		    idField:'id',
		    treeField:'name',
		    fitColumns:true,
		    striped: true,
		    ...
		    columns:[[
				...
				{title:'菜单路径',field:'resUrl',width:150},
...
function editUI(){
	...
	pageii = layer.open({
		...
		maxmin :true,
		area : [ "1200px", "600px" ],
		content : rootPath + '/resources/editUI.shtml?id='+selectRow.id,
		end :function(){//关闭时执行
			treeTable.treegrid("reload");
		}
	});
...
function deleteAll(){
	...
	if(selectRow)
	{
		...
		layer.confirm('是否删除？', function(index) {
			var url = rootPath + '/resources/deleteAll.shtml';
