...
function _Scene3DAddPoly(oo) {
	...
	if (useSVG) {
		...
		this.Shape[ii].setAttribute("style","stroke-width:1.2;stroke:#8B8989;stroke-opacity:0.9;"); 
...
function _Poly3DDraw(aShape) {
	...
	if (useSVG) {
		...
		if(text=="undefined" || text=="err" || text=="ERR" || text=="NULL" || text=="null"){
			aShape.nextSibling.textContent = "D-E";  
		}else if(eval(text)>=300){
			aShape.nextSibling.textContent = "D-E";  
		}
		else{
		...
		if ((ll >= 3) && (this.FrontColor != ""))
			if (Number(text) <= 10)
				aShape.setAttribute("fill", this.Parent.GetColor("#00FF00",this.BackColor, this.Normal, this.Center));
			else if (Number(text) <= 20)
				aShape.setAttribute("fill", this.Parent.GetColor("#EEEE00",this.BackColor, this.Normal, this.Center));
			else if (Number(text) <= 30)
				aShape.setAttribute("fill", this.Parent.GetColor("#EE7621",this.BackColor, this.Normal, this.Center));
			else if (Number(text) <= 50)
				aShape.setAttribute("fill", this.Parent.GetColor("#FF3030",this.BackColor, this.Normal, this.Center));
			else
				aShape.setAttribute("fill", this.Parent.GetColor("#ADADAD",this.BackColor, this.Normal, this.Center));
		if (this.StrokeColor)
